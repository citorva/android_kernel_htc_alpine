...
#ifdef CONFIG_SND_SOC_TFA98XX_ADDR
#define TFA_ADDR CONFIG_SND_SOC_TFA98XX_ADDR
#else
#define TFA_ADDR "34"
#endif

#ifdef CONFIG_SND_SOC_TFA98XX_BUS
#define TFA_BUS CONFIG_SND_SOC_TFA98XX_BUS
#else
#define TFA_BUS "4"
#endif

#define TFA_CODEC_NAME "tfa98xx."TFA_BUS"-00"TFA_ADDR
#define TFA_CODEC_DAI_NAME "tfa98xx-aif-"TFA_BUS"-"TFA_ADDR
