...
typedef enum {
	...
	Soc_Aud_Digital_Block_I2S_OUT_DAC_2,	
	Soc_Aud_Digital_Block_I2S_IN_ADC,
	Soc_Aud_Digital_Block_I2S_IN_ADC_2,	
	
	Soc_Aud_Digital_Block_I2S_OUT_2,
	Soc_Aud_Digital_Block_I2S_IN_2,
	Soc_Aud_Digital_Block_I2S_4PIN_IN_OUT,	
...
typedef enum {
	STREAMSTATUS_STATE_FREE = -1,	
	STREAMSTATUS_STATE_STANDBY,	
	STREAMSTATUS_STATE_EXECUTING,	
} STREAMSTATUS;
