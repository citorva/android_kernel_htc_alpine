...
struct himax_i2c_platform_data {
	...
	struct pinctrl_state *gpio_reset_suspend;
};
...
#ifdef CONFIG_OF
extern int himax_pinctrl_init(struct device *dev);
extern void himax_pinctrl_deinit(struct device *dev);
extern int himax_pinctrl_select(struct device *dev, int on);
#endif
#endif
