...
typedef enum {
	...
	CW_ROTATIONVECTOR_ACCURACY     = 102
} CW_SENSORS_ID;
...
#define TOUCH_POWER_REGISTER						0xF6
...
#define TOUCH_SOLUTION_HIMAX8527X                  2
...
#define CW_I2C_AUD_GPIO_SETTING                                 0x19
...
#define CW_I2C_REG_SENSORS_AUTOK_THD_GET_DATA_PROXIMITY 		0xA9
#define CW_I2C_REG_SENSORS_AUTOK_THD_SET_DATA_PROXIMITY			0xA9
...
#define CW_I2C_REG_RV_CALIBRATION                               0xD0
#define CW_I2C_REG_RV_CALI_THD                                  0xD4
