...
#define PDO_FIXED_HIGH_CAP	(1 << 28) 
#define PDO_FIXED_EXTERNAL  (1 << 27) 
#define PDO_FIXED_COMM_CAP  (1 << 26) 
...
#define HPD_DSTREAM_DEBOUNCE_IRQ (750)  
...
#define USB_SID_RICHTEK	0x29cf  
#define USB_SID_DIRECTCHARGE	0x29cf  
