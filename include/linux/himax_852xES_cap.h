...
static struct proc_dir_entry *himax_proc_reset_file 		= NULL;
	...
	static int HX_2T2R_Addr = 0x96;
	static int HX_2T2R_en_setting = 0x02;
...
static int gest_key_pt_y[3];
	...
	#define KEY_CUST_01 0x21d 
	#define KEY_CUST_02 0x21e 
	#define KEY_CUST_03 0x21c 
	#define KEY_CUST_04 0x21b 
	#define KEY_CUST_05 0x225 
	#define KEY_CUST_06 0x226 
	#define KEY_CUST_07 0x222 
	#define KEY_CUST_08 0x220 
	#define KEY_CUST_09 0x226 
	#define KEY_CUST_10 0x228 
	#define KEY_CUST_11 0x223 
	#define KEY_CUST_12 0x221 
