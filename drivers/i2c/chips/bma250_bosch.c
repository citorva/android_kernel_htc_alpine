...
static DEVICE_ATTR(range, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_range_show, bma250_range_store);
static DEVICE_ATTR(bandwidth, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_bandwidth_show, bma250_bandwidth_store);
static DEVICE_ATTR(mode, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_mode_show, bma250_mode_store);
static DEVICE_ATTR(value, S_IRUGO,
		bma250_value_show, NULL);
static DEVICE_ATTR(delay, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_delay_show, bma250_delay_store);
static DEVICE_ATTR(enable, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_enable_show, bma250_enable_store);
static DEVICE_ATTR(enable_int, 0220/*S_IWUSR|S_IWGRP|S_IWOTH*/,
		NULL, bma250_enable_int_store);
static DEVICE_ATTR(int_mode, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_int_mode_show, bma250_int_mode_store);
static DEVICE_ATTR(slope_duration, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_slope_duration_show, bma250_slope_duration_store);
static DEVICE_ATTR(slope_threshold, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_slope_threshold_show, bma250_slope_threshold_store);
static DEVICE_ATTR(high_g_duration, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_high_g_duration_show, bma250_high_g_duration_store);
static DEVICE_ATTR(high_g_threshold, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_high_g_threshold_show, bma250_high_g_threshold_store);
static DEVICE_ATTR(low_g_duration, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_low_g_duration_show, bma250_low_g_duration_store);
static DEVICE_ATTR(low_g_threshold, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_low_g_threshold_show, bma250_low_g_threshold_store);
static DEVICE_ATTR(tap_duration, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_tap_duration_show, bma250_tap_duration_store);
static DEVICE_ATTR(tap_threshold, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_tap_threshold_show, bma250_tap_threshold_store);
static DEVICE_ATTR(tap_quiet, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_tap_quiet_show, bma250_tap_quiet_store);
static DEVICE_ATTR(tap_shock, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_tap_shock_show, bma250_tap_shock_store);
static DEVICE_ATTR(tap_samp, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_tap_samp_show, bma250_tap_samp_store);
static DEVICE_ATTR(orient_mode, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_orient_mode_show, bma250_orient_mode_store);
static DEVICE_ATTR(orient_blocking, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_orient_blocking_show, bma250_orient_blocking_store);
static DEVICE_ATTR(orient_hyst, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_orient_hyst_show, bma250_orient_hyst_store);
static DEVICE_ATTR(orient_theta, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_orient_theta_show, bma250_orient_theta_store);
static DEVICE_ATTR(flat_theta, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_flat_theta_show, bma250_flat_theta_store);
static DEVICE_ATTR(flat_hold_time, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_flat_hold_time_show, bma250_flat_hold_time_store);
static DEVICE_ATTR(reg, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_register_show, bma250_register_store);
static DEVICE_ATTR(fast_calibration_x, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_fast_calibration_x_show,
		bma250_fast_calibration_x_store);
static DEVICE_ATTR(fast_calibration_y, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_fast_calibration_y_show,
		bma250_fast_calibration_y_store);
static DEVICE_ATTR(fast_calibration_z, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_fast_calibration_z_show,
		bma250_fast_calibration_z_store);
static DEVICE_ATTR(selftest, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		bma250_selftest_show, bma250_selftest_store);
static DEVICE_ATTR(eeprom_writing, 0664/*S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH*/,
		NULL, bma250_eeprom_writing_store);

static DEVICE_ATTR(chip_layout, 0664/*S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP*/,
		bma250_chip_layout_show, bma250_chip_layout_store);

static DEVICE_ATTR(get_raw_data, 0444/*S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP*/,
		bma250_get_raw_data_show, NULL);

static DEVICE_ATTR(set_k_value, 0664/*S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP*/,
		bma250_set_k_value_show, bma250_set_k_value_store);

static DEVICE_ATTR(flush, 0664/*S_IRUSR|S_IWUSR|S_IRGRP|S_IWGRP*/,
