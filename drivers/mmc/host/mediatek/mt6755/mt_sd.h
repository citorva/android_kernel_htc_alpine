...
struct msdc_hw {
	...
	unsigned int  boot;              
	unsigned char host_function;    
	unsigned char cd_level;         
...
struct msdc_host {
	...
	struct work_struct	work_tune; 
	struct mmc_request	*mrq_tune; 
#endif
