...
#define D(fmt, args...) printk(KERN_DEBUG "[mtk-tpd][TP][%s|%d] " fmt, __func__, __LINE__, ##args)
#else
#define D(fmt, args...)
#endif
#define I(fmt, args...) printk(KERN_INFO "[mtk-tpd][TP] " fmt, ##args)
#define W(fmt, args...) printk(KERN_WARNING "[mtk-tpd][TP][WARNING] " fmt, ##args)
#define E(fmt, args...) printk(KERN_ERR "[mtk-tpd][TP][ERROR] " fmt, ##args)

#define	CONFIG_TOUCHSCREEN_TOUCH_FW_UPDATE	1
#ifdef DEBUG
#define	CONFIG_TOUCHSCREEN_TOUCH_FW_UPDATE	1
#define CONFIG_MTK_SH_SUPPORT
#define FT5X0X_FIRMWARE
#define FT_AUTO_UPGRADE_SUPPORT
#define CUST_FTS_APK_DEBUG
#endif
...
#define FTS_REG_FW_CUR_VER                  0xef			
#define FTS_REG_CHIP_ID_HIGH				0xA3    		
#define FTS_REG_CHIP_ID_LOW					0x9f    		
#define FTS_REG_PMODE						0xA5			
#define FTS_REG_FW_VER						0xA6   			
#define FTS_REG_VENDOR_ID					0xA8   			
#define FTS_REG_POINT_RATE					0x88   			
#ifdef CONFIG_FOCAL_STATUS_DEBUG
#define FTS_REG_FW_BUFFER					0x9D			
#define FTS_REG_FW_STATUS					0x7C			
#endif
...
struct ts_event 
{
	...
	u16 press[CFG_MAX_TOUCH_POINTS];
...
extern int focal_rst_set(int level);
