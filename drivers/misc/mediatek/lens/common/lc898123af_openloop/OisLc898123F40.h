...
#define			StMeasFunc_PMC_SiFsCountF		0x0004 + StMeasFunc_PMC_UcCrossDetectB	
...
#define			MeasureFilterA_Temp_b1			0x0000 + MeasureFilterA_Temp			
#define			MeasureFilterA_Temp_c1			0x0004 + MeasureFilterA_Temp_b1			
#define			MeasureFilterA_Temp_a1			0x0004 + MeasureFilterA_Temp_c1			
#define			MeasureFilterA_Temp_b2			0x0004 + MeasureFilterA_Temp_a1			
#define			MeasureFilterA_Temp_c2			0x0004 + MeasureFilterA_Temp_b2			
#define			MeasureFilterA_Temp_a2			0x0004 + MeasureFilterA_Temp_c2			

#define		MeasureFilterB_Temp				0x8608
				
#define			MeasureFilterB_Temp_b1			0x0000 + MeasureFilterB_Temp			
#define			MeasureFilterB_Temp_c1			0x0004 + MeasureFilterB_Temp_b1			
#define			MeasureFilterB_Temp_a1			0x0004 + MeasureFilterB_Temp_c1			
#define			MeasureFilterB_Temp_b2			0x0004 + MeasureFilterB_Temp_a1			
#define			MeasureFilterB_Temp_c2			0x0004 + MeasureFilterB_Temp_b2			
#define			MeasureFilterB_Temp_a2			0x0004 + MeasureFilterB_Temp_c2			
