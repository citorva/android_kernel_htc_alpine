...
#define FGD_NL_MSG_MAX_LEN 11400
...
struct battery_meter_custom_data {
	...
	int sync_ui_soc_imm;                  
	int mtk_enable_aging_algorithm; 
	int md_sleep_current_check;     
	int q_max_by_current;           
...
typedef enum {
	...
	FG_DAEMON_CMD_IS_BATTERY_FULL,	
	FG_DAEMON_CMD_SET_BATTERY_FULL,	
	FG_DAEMON_CMD_SET_RTC,	
	FG_DAEMON_CMD_SET_POWEROFF,	
	FG_DAEMON_CMD_IS_KPOC,	
	FG_DAEMON_CMD_GET_BOOT_REASON,	
	...
	FG_DAEMON_CMD_GET_CUSTOM_AGING_FACTOR,
...
extern signed int battery_meter_get_VSense(void);
