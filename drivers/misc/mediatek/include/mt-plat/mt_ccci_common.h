...
#define CCCI_IOC_RESET_MD1_MD3_PCCIF	_IO(CCCI_IOC_MAGIC, 45) 
...
#define CCCI_IOC_SET_CCIF_CG			_IOW(CCCI_IOC_MAGIC, 54, unsigned int) 
#define CCCI_IOC_SET_EFUN               _IOW(CCCI_IOC_MAGIC, 55, unsigned int) 
...
enum {
	...
	C2K_STATUS_IND_MSG = 0x201, 
	C2K_STATUS_QUERY_MSG = 0x202, 
	C2K_HB_MSG = 0x207,
...
struct ccci_image_info {
	...
	struct IMG_REGION_INFO rmpu_info;  
};
...
int ccci_sysfs_add_modem(int md_id, void *kobj, void *ktype,
					get_status_func_t, boot_md_func_t); 
