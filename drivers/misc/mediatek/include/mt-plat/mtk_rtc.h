...
extern int get_rtc_spare_coulomb_value(void);
extern int set_rtc_spare_coulomb_value(int val);
...
#define get_rtc_spare_coulomb_value()		({ 0; })
#define set_rtc_spare_coulomb_value(val)	({ 0; })
