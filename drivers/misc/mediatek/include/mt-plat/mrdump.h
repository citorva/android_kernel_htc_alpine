...
int mrdump_set_ramdump_reason(AEE_REBOOT_MODE reset_reson, char *msg);
/* HTC-- */
...
/* HTC++ */
static inline AEE_REBOOT_MODE mrdump_get_ramdump_reason(void) {return 0;};
static inline int mrdump_set_ramdump_reason(AEE_REBOOT_MODE reset_reson, char *msg) {return 0;};
/* HTC-- */
