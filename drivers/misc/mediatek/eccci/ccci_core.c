...
void ccci_config_modem(struct ccci_modem *md)
{
	...
	if (md->index == MD_SYS1) {
		...
		md->smem_layout.ccci_smart_logging_size = md->mem_layout.smem_region_size -
								CCCI_SMEM_SIZE_MISC_PART - CCCI_SMEM_SIZE_LWA_SMEM;
#ifdef FEATURE_LWA
		
		md->smem_layout.ccci_lwa_smem_base_phy = md->smem_layout.ccci_smart_logging_base_phy +
							md->smem_layout.ccci_smart_logging_size;
		md->smem_layout.ccci_lwa_smem_base_vir = md->smem_layout.ccci_smart_logging_base_vir +
							md->smem_layout.ccci_smart_logging_size;
		md->smem_layout.ccci_lwa_smem_size = CCCI_SMEM_SIZE_LWA_SMEM;
#endif
#else
		md->smem_layout.ccci_smart_logging_size = md->mem_layout.smem_region_size -
								CCCI_SMEM_SIZE_MISC_PART;
#endif
		
		md->smem_layout.ccci_exp_smem_base_phy = md->mem_layout.smem_region_phy +
					md->mem_layout.smem_region_size - CCCI_SMEM_SIZE_MISC_PART;
		md->smem_layout.ccci_exp_smem_base_vir = md->mem_layout.smem_region_vir +
					md->mem_layout.smem_region_size - CCCI_SMEM_SIZE_MISC_PART;
	} else if (md->index == MD_SYS3) {
		
		md->smem_layout.ccci_exp_smem_base_phy = md->mem_layout.smem_region_phy + CCCI_SMEM_OFFSET_MISC_PART;
		md->smem_layout.ccci_exp_smem_base_vir = md->mem_layout.smem_region_vir + CCCI_SMEM_OFFSET_MISC_PART;
...
#ifdef FEATURE_LWA
	if (md->index == MD_SYS1) {
		md->smem_layout.ccci_lwa_smem_base_phy = md->mem_layout.smem_region_phy;
		md->smem_layout.ccci_lwa_smem_base_vir = md->mem_layout.smem_region_vir;
		md->smem_layout.ccci_lwa_smem_size = CCCI_SMEM_SIZE_LWA_SMEM;
		md->mem_layout.smem_region_phy += CCCI_SMEM_SIZE_LWA_SMEM;
		md->mem_layout.smem_region_vir += CCCI_SMEM_SIZE_LWA_SMEM;
	}
#endif
#endif
...
#ifndef CCCI_TRAFFIC_LOG_LEVEL
#define CCCI_TRAFFIC_LOG_LEVEL 1
#endif
unsigned int ccci_traffic_debug_enable = CCCI_TRAFFIC_LOG_LEVEL;
