...
#ifdef CONFIG_HTC_FEATURES_RIL_PCN0007_LWA
	{CCCI_SMEM_CH, CCCI_SMEM_CH, 0xFF, 0xFF, 0xFF, 0xFF, 0, &char_port_ops, 5, "ccci_raw_lwa",},
#endif
};
#endif
...
static struct ccci_port md3_ccci_ports[] = {
	...
	{CCCI_IPC_UART_TX, CCCI_IPC_UART_RX, 6, 6, 0xFF, 0xFF, 0, &char_port_ops, 5, "ccci3_tty2",},	
