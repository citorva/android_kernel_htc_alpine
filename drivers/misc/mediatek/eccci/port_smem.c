...
static struct ccci_smem_port md1_ccci_smem_ports[] = {
	{SMEM_USER_RAW_DBM, TYPE_RAW, }, 
	{SMEM_USER_CCB_DHL, TYPE_CCB, }, 
	{SMEM_USER_RAW_DHL, TYPE_RAW, }, 
	{SMEM_USER_RAW_NETD, TYPE_RAW, }, 
	{SMEM_USER_RAW_USB, TYPE_RAW, }, 
#ifdef CONFIG_HTC_FEATURES_RIL_PCN0007_LWA
	{SMEM_USER_RAW_LWA, TYPE_RAW, }, 
#endif
};
...
#ifdef CONFIG_HTC_FEATURES_RIL_PCN0007_LWA
		md1_ccci_smem_ports[SMEM_USER_RAW_LWA].addr_vir = md->smem_layout.ccci_lwa_smem_base_vir;
		md1_ccci_smem_ports[SMEM_USER_RAW_LWA].addr_phy = md->smem_layout.ccci_lwa_smem_base_phy;
		md1_ccci_smem_ports[SMEM_USER_RAW_LWA].length = md->smem_layout.ccci_lwa_smem_size;
#endif
