...
WLAN_STATUS wlanQueryNicCapability(IN P_ADAPTER_T prAdapter)
{
	...
	DBGLOG(NIC, INFO, "FW Ver DEC[%u.%u] HEX[%x.%x], Driver Ver[%u.%u]\n",
					    (UINT_32)(prAdapter->rVerInfo.u2FwOwnVersion >> 8),
					    (UINT_32)(prAdapter->rVerInfo.u2FwOwnVersion & BITS(0, 7)),
					     (UINT_32)(prAdapter->rVerInfo.u2FwOwnVersion >> 8),
					    (UINT_32)(prAdapter->rVerInfo.u2FwOwnVersion & BITS(0, 7)),
					    (UINT_32)(prAdapter->rVerInfo.u2FwPeerVersion >> 8),
					   (UINT_32)(prAdapter->rVerInfo.u2FwPeerVersion & BITS(0, 7)));
