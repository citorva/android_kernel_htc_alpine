...
#define AIS_BLACKLIST_TIMEOUT               15 
...
typedef enum _EMUN_RECONNECT_LEVEL_T {
	...
	RECONNECT_LEVEL_INTER_OTHER = RECONNECT_LEVEL_MIN + 1,				
	RECONNECT_LEVEL_INTER_DRIVER = RECONNECT_LEVEL_INTER_OTHER + 1,		
	RECONNECT_LEVEL_INTER_SET = RECONNECT_LEVEL_INTER_DRIVER + 1,		
	RECONNECT_LEVEL_MAX
