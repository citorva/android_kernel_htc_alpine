...
#if defined(CONFIG_MTK_PMIC_CHIP_MT6353)
#define CPU_DVFS_FREQ0_LL   (1001000)	
#define CPU_DVFS_FREQ1_LL    (910000)	
#define CPU_DVFS_FREQ2_LL    (819000)	
#define CPU_DVFS_FREQ3_LL    (689000)	
#define CPU_DVFS_FREQ4_LL    (598000)	
#define CPU_DVFS_FREQ5_LL    (494000)	
#define CPU_DVFS_FREQ6_LL    (338000)	
#define CPU_DVFS_FREQ7_LL    (156000)	

#define CPU_DVFS_FREQ0_L    (1508000)	
#define CPU_DVFS_FREQ1_L    (1430000)	
#define CPU_DVFS_FREQ2_L    (1352000)	
#define CPU_DVFS_FREQ3_L    (1196000)	
#define CPU_DVFS_FREQ4_L    (1027000)	
#define CPU_DVFS_FREQ5_L    (871000)	
#define CPU_DVFS_FREQ6_L    (663000)	
#define CPU_DVFS_FREQ7_L    (286000)	
#else
...
#define CPU_DVFS_FREQ0_L    (1807000)	
#define CPU_DVFS_FREQ1_L    (1651000)	
#define CPU_DVFS_FREQ2_L    (1495000)	
#define CPU_DVFS_FREQ3_L    (1196000)	
#define CPU_DVFS_FREQ4_L    (1027000)	
#define CPU_DVFS_FREQ5_L    (871000)	
#define CPU_DVFS_FREQ6_L    (663000)	
...
#define CPU_DVFS_FREQ0_LL_SB    (1144000)	
#define CPU_DVFS_FREQ1_LL_SB    (1014000)	
#define CPU_DVFS_FREQ2_LL_SB    (871000)	
#define CPU_DVFS_FREQ3_LL_SB    (689000)	
#define CPU_DVFS_FREQ4_LL_SB    (598000)	
#define CPU_DVFS_FREQ5_LL_SB    (494000)	
#define CPU_DVFS_FREQ6_LL_SB    (338000)	
#define CPU_DVFS_FREQ7_LL_SB    (156000)	

#define CPU_DVFS_FREQ0_L_SB    (1950000)	
#define CPU_DVFS_FREQ1_L_SB    (1755000)	
#define CPU_DVFS_FREQ2_L_SB    (1573000)	
#define CPU_DVFS_FREQ3_L_SB    (1196000)	
#define CPU_DVFS_FREQ4_L_SB    (1027000)	
#define CPU_DVFS_FREQ5_L_SB    (871000)		
#define CPU_DVFS_FREQ6_L_SB    (663000)		
#define CPU_DVFS_FREQ7_L_SB    (286000)		
...
struct mt_cpu_dvfs {
	...
	enum top_ckmuxsel_cci armpll_clk_src;	
	struct mt_cpu_freq_method *freq_tbl;	
	struct mt_cpu_freq_info *opp_tbl;	
	int nr_opp_tbl;		
	int idx_opp_tbl;	
	int idx_opp_ppm_base;	
	int idx_opp_ppm_limit;	
	int armpll_is_available;	
...
static void adjust_armpll_dds(struct mt_cpu_dvfs *p, unsigned int dds, unsigned int pos_div)
{
	...
	cpufreq_write(p->armpll_addr, dds | _BIT_(31)); 
...
static int _mt_cpufreq_init(struct cpufreq_policy *policy)
{
...

	{
		...
		policy->cur = p->ops->get_cur_phy_freq(p);	
		if (p->idx_opp_ppm_limit == -1)
