...
static 	wait_queue_head_t WaitQueueHead_ImemDbgDump;
typedef	struct{
...
static 	wait_queue_head_t WaitQueueHead_ImemDbgDumpDone;
...
MBOOL ISP_chkModuleSetting(void)
{
	...
	MUINT32 cam_ctrl_en_p1;	
	MUINT32 cam_ctrl_sel_pl;	
	MUINT32 cam_bmx_crop;	
	MUINT32 cam_bmx_vsize;	

	MUINT32 cam_tg1_vf_con;	
	MUINT32 cam_tg2_vf_con;	

	MUINT32 grab_width;
	MUINT32 grab_height;

	MUINT32 cam_tg1_sen_grab_pxl;	
	MUINT32 cam_tg1_sen_grab_lin;	

	MUINT32 cam_tg2_sen_grab_pxl;	
	MUINT32 cam_tg2_sen_grab_lin;	
	...
	if (cam_tg1_vf_con & 0x01) {
		...
		MUINT32 cam_flk_con;	
		MUINT32 cam_flk_ofst;	
		MUINT32 cam_flk_size;	
		MUINT32 cam_flk_num;	

		MUINT32 cam_esfko_xsize;	
		...
		MUINT32 cam_af_con;	
		MUINT32 cam_af_winx_1;	
		MUINT32 cam_af_winx_2;	
		MUINT32 cam_af_winx_3;	
		MUINT32 cam_af_winy_1;	
		MUINT32 cam_af_winy_2;	
		MUINT32 cam_af_winy_3;	
		MUINT32 cam_af_size;	

		MUINT32 cam_af_flt_1;	
		MUINT32 cam_af_flt_2;	
		MUINT32 cam_af_flt_3;	
		MUINT32 cam_af_th;	
		MUINT32 cam_af_flo_win_1;	
		MUINT32 cam_af_flo_size_1;	
		MUINT32 cam_af_flo_win_2;	
		MUINT32 cam_af_flo_size_2;	
		MUINT32 cam_af_flo_win_3;	
		MUINT32 cam_af_flo_size_3;	
		MUINT32 cam_af_flo_th;	
		MUINT32 cam_af_image_size;	
		...
		MUINT32 cam_aao_xsize;	
		MUINT32 cam_aao_ysize;	
		MUINT32 cam_awb_win_num;	
		MUINT32 cam_ae_hst_ctl;	
		...
		MUINT32 cam_awb_win_org;	
		MUINT32 cam_awb_win_pit;	
		...
		MUINT32 cam_rrz_out_img;	
		MUINT32 cam_ctl_scenario;	
		...
		MUINT32 CAM_EIS_PREP_ME_CTRL1;	
		MUINT32 CAM_EIS_MB_OFFSET;	
		MUINT32 CAM_EIS_MB_INTERVAL;	
		MUINT32 CAM_EIS_IMAGE_CTRL;	
		...
		cam_af_flt_1 = ISP_RD32(ISP_ADDR + 0x6D4);	
		cam_af_flt_2 = ISP_RD32(ISP_ADDR + 0x6D8);	
		cam_af_flt_3 = ISP_RD32(ISP_ADDR + 0x6DC);	
		cam_af_th = ISP_RD32(ISP_ADDR + 0x6E0);	
		cam_af_flo_win_1 = ISP_RD32(ISP_ADDR + 0x6E4);	
		cam_af_flo_size_1 = ISP_RD32(ISP_ADDR + 0x6E8);	
		cam_af_flo_win_2 = ISP_RD32(ISP_ADDR + 0x6EC);	
		cam_af_flo_size_2 = ISP_RD32(ISP_ADDR + 0x6F0);	
		cam_af_flo_win_3 = ISP_RD32(ISP_ADDR + 0x6F4);	
		cam_af_flo_size_3 = ISP_RD32(ISP_ADDR + 0x6F8);	
		cam_af_flo_th = ISP_RD32(ISP_ADDR + 0x6FC);	
		cam_af_image_size = ISP_RD32(ISP_ADDR + 0x700);	
	...
	if (cam_tg2_vf_con & 0x01) {
		...
		cam_af_flt_1 = ISP_RD32(ISP_ADDR + 0x26D4);	
		cam_af_flt_2 = ISP_RD32(ISP_ADDR + 0x26D8);	
		cam_af_flt_3 = ISP_RD32(ISP_ADDR + 0x26DC);	
		cam_af_th = ISP_RD32(ISP_ADDR + 0x26E0);	
		cam_af_flo_win_1 = ISP_RD32(ISP_ADDR + 0x26E4);	
		cam_af_flo_size_1 = ISP_RD32(ISP_ADDR + 0x26E8);	
		cam_af_flo_win_2 = ISP_RD32(ISP_ADDR + 0x26EC);	
		cam_af_flo_size_2 = ISP_RD32(ISP_ADDR + 0x26F0);	
		cam_af_flo_win_3 = ISP_RD32(ISP_ADDR + 0x26F4);	
		cam_af_flo_size_3 = ISP_RD32(ISP_ADDR + 0x26F8);	
		cam_af_flo_th = ISP_RD32(ISP_ADDR + 0x26FC);	
		cam_af_image_size = ISP_RD32(ISP_ADDR + 0x2700);	
