...
typedef struct {
	...
	long (*set_ioexp_gpio_lcd_enp_bias)(unsigned int value);
	long (*set_ioexp_gpio_lcd_enn_bias)(unsigned int value);
	long (*set_ioexp_gpio_lm36274_hwen)(unsigned int value);
	long (*set_ioexp_tp_reset_pin)(unsigned int value);
#else
	long (*set_gpio_lcd_enp_bias)(unsigned int value);
	long (*set_gpio_lcd_enn_bias)(unsigned int value);
#endif
	long (*set_gpio_lcd_io_18_en)(unsigned int value);
	long (*set_gpio_lcdbl_en)(unsigned int value);
