...
LCM_DRIVER r63452_fhd_dsi_cmd_jdi_lcm_drv;
...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xB0, 1, {0x00}},
	{0xCA, 43, {0x1D, 0xFC, 0xFC, 0xFC, 0xE5, 0x10, 0x10, 0xDC,
			0x00, 0xDC, 0xD9, 0x00, 0x00, 0xA0, 0x00, 0xD0,
			0x00, 0xC1, 0x00, 0xF9, 0xDF, 0xF9, 0x9F, 0x6E,
			0x61, 0x9D, 0x69, 0x5B, 0x2D, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00}},
	{0xB9, 7, {0x67, 0x44, 0x20, 0x20, 0x14, 0xC8, 0xC8}},
	{0xBC, 2, {0x37, 0x32}},
	{0xCE, 25, {0x55, 0x50, 0x70, 0x8F, 0x98, 0xA6, 0xBF, 0xCE,
			0xD4, 0xD8, 0xDE, 0xDF, 0xE2, 0xE5, 0xEC, 0xF3,
			0xFF, 0x00, 0xE3, 0x04, 0x04, 0x42, 0x04, 0x69,
			0x5A}},
	{0x55, 1, {0x82}},
	{0xB0, 1, {0x03}},
...
static void lcm_get_params(LCM_PARAMS *params) {
	...
	params->pwm_min = 3;
	params->pwm_default = 68;
	params->pwm_max = 255;
	params->camera_blk = 169;
}

static void lcm_power_on(void) {

	if (r63452_fhd_dsi_cmd_jdi_lcm_drv.mipi_lp11) {
