...
#if defined(HX8394F_HD_DSI_VDO_TIANMA)
	&hx8394f_hd_dsi_vdo_tianma_lcm_drv,
#endif
...
#if defined(HX8394F_HD_DSI_VDO_TRULY_EVM)
	&hx8394f_hd_dsi_vdo_truly_evm_lcm_drv,
#endif

#if defined(FT8716_FHD_DSI_VDO_TIANMA)
	&ft8716_fhd_dsi_vdo_tianma_lcm_drv,
#endif

#if defined(SGM3747_FHD_DSI_VDO_TIANMA)
        &sgm3747_fhd_dsi_vdo_tianma_lcm_drv,
#endif

#if defined(R63452_FHD_DSI_CMD_JDI_EVM)
	&r63452_fhd_dsi_cmd_jdi_evm_lcm_drv,
#endif

#if defined(R63452_FHD_DSI_CMD_JDI)
	&r63452_fhd_dsi_cmd_jdi_lcm_drv,
#endif
};
...
#if defined(HX8394F_HD_DSI_VDO_TIANMA)
	"hx8394f_hd_dsi_vdo_tianma",
#endif

#if defined(HX8394F_HD_DSI_VDO_TRULY)
	"hx8394f_hd_dsi_vdo_truly",
#endif

#if defined(HX8394F_HD_DSI_VDO_TRULY_EVM)
	"hx8394f_hd_dsi_vdo_truly_evm",
#endif

#if defined(R63452_FHD_DSI_CMD_JDI_EVM)
	"r63452_fhd_dsi_cmd_jdi_evm",
#endif

#if defined(R63452_FHD_DSI_CMD_JDI)
	"r63452_fhd_dsi_cmd_jdi",
#endif
};
