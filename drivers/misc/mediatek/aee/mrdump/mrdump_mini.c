...
void mrdump_mini_add_entry_ex(unsigned long addr, unsigned long size, unsigned long paddr) {
	...
	if (i < MRDUMP_MINI_NR_SECTION)
		fill_elf_load_phdr(phdr, size, addr, paddr);
}
