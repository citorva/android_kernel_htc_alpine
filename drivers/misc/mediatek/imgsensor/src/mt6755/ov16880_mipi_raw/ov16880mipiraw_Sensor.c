...
#define LOG_2 LOG_INF("preview 2336*1752@30fps,768Mbps/lane; video 4672*3488@30fps,1440Mbps/lane; capture 16M@30fps,1440Mbps/lane\n")
...
extern bool read_ov16880_eeprom( u16 addr, BYTE* data, u32 size);
...
{{ 4704, 3536,	   0,     8, 4704, 3520, 2352, 1760,  8, 2, 2336, 1752,	  0,	0, 2336, 1752}, 
 { 4704, 3536,	   0,     8, 4704, 3520, 4704, 3520, 16, 8, 4672, 3504,	  0,	8, 4672, 3488}, 
 { 4704, 3536,	   0,     8, 4704, 3520, 4704, 3520, 216, 558, 4272, 2404,	  0,	0, 4272, 2404}, 
...
static const char *ov16880Vendor = "Sunny";
static const char *ov16880NAME = "ov16880";
static const char *ov16880Size = "16M";
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	printk("\n[ryf][ov16880]This is function get_imgsensor_id!t\n");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {	
			*sensor_id = (read_cmos_sensor_8(0x300A) << 16) | (read_cmos_sensor_8(0x300B)<<8) | read_cmos_sensor_8(0x300C);
			printk("\n[ryf][ov16880]This is function get_imgsensor_id!the value of sensor_id is 0x%x\n",*sensor_id);
...
static kal_uint32 open(void)
{
	...
	LOG_1;
	LOG_2;
	printk("\n[ryf][ov16880]This is function open!\n");
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	LOG_INF("[PDAF]feature_id = %d\n", feature_id);
	LOG_INF("[PDAF]SENSOR_FEATURE_GET_PDAF_DATA =%d\n",SENSOR_FEATURE_GET_PDAF_DATA);
	switch (feature_id) 
	{
