...
typedef struct cam_gpio_config {
       struct pinctrl *pinctrl;
       struct pinctrl_state *pins_cam_gpio_high;
       struct pinctrl_state *pins_cam_gpio_low;
       struct pinctrl_state *pins_cam_fw_high;
       struct pinctrl_state *pins_cam_fw_low;
}cam_gpio_config;
