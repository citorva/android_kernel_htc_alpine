...
#define U3D_USBPHYACR2_0	(SSUSB_SIFSLV_U2PHY_COM_BASE+0x0008)	
...
#define RG_USB20_DP_ABIST_SOURCE_EN        (0x1<<31)	
#define RG_USB20_DP_ABIST_SELE             (0xf<<24)	
#define RG_USB20_ICUSB_EN                  (0x1<<16)	
...
#define RG_USB20_ISO_EN                    (0x1U<<31)	
...
#define RGO_USB20_GPIO_DM_O                (0x1<<1)	
#define RGO_USB20_GPIO_DP_O                (0x1<<0)	
...
#define RG_USB20_PRBS7_BERTH               (0xff<<0)	
...
#define RGO_TXVALID_CNT                    (0xff<<24)	
#define RGO_RXACTIVE_CNT                   (0xff<<16)	
#define RGO_USB20_LB_BERCNT                (0xff<<8)	
#define USB20_PROBE_OUT                    (0xff<<0)	

#define RGO_USB20_PRBS7_ERRCNT             (0xffff<<16)	
#define RGO_USB20_PRBS7_DONE               (0x1<<3)	
#define RGO_USB20_PRBS7_LOCK               (0x1<<2)	
#define RGO_USB20_PRBS7_PASS               (0x1<<1)	
#define RGO_USB20_PRBS7_PASSTH             (0x1<<0)	

#define RG_SIFSLV_CHGDT_DEGLCH_CNT         (0xf<<28)	
#define RG_SIFSLV_CHGDT_CTRL_CNT           (0xf<<24)	
#define RG_SIFSLV_CHGDT_FORCE_MODE         (0x1<<16)	
#define RG_CHGDT_ISRC_LEV                  (0x3<<14)	
#define RG_CHGDT_VDATSRC                   (0x1<<13)	
#define RG_CHGDT_BGVREF_SEL                (0x7<<10)	
#define RG_CHGDT_RDVREF_SEL                (0x3<<8)	
#define RG_CHGDT_ISRC_DP                   (0x1<<7)	
#define RG_SIFSLV_CHGDT_OPOUT_DM           (0x1<<6)	
#define RG_CHGDT_VDAT_DM                   (0x1<<5)	
#define RG_CHGDT_OPOUT_DP                  (0x1<<4)	
#define RG_SIFSLV_CHGDT_VDAT_DP            (0x1<<3)	
#define RG_SIFSLV_CHGDT_COMP_EN            (0x1<<2)	
#define RG_SIFSLV_CHGDT_OPDRV_EN           (0x1<<1)	
#define RG_CHGDT_EN                        (0x1<<0)	

#define RG_CHGDT_REV                       (0xff<<0)	

#define USB11_OTG_REG                      (0x1<<4)	
#define USB20_OTG_REG                      (0x1<<3)	
#define CHGDT_REG                          (0x1<<2)	
#define USB11_REG                          (0x1<<1)	
#define USB20_REG                          (0x1<<0)	

#define VERSION_CODE_REGFILE               (0xff<<24)	
#define USB11_VERSION_CODE                 (0xff<<16)	
#define VERSION_CODE_ANA                   (0xff<<8)	
#define VERSION_CODE_DIG                   (0xff<<0)	

#define RG_PAGE                            (0xff<<24)	
#define I2C_MODE                           (0x1<<16)	
...
#define RG_SSUSB_REF_EN                    (0x1<<15)	
#define RG_SSUSB_VRT_VREF_SEL              (0xf<<11)	
#define RG_SSUSB_BG_MONEN                  (0x1<<8)	
#define RG_SSUSB_INT_BIAS_SEL              (0x1<<7)	
#define RG_SSUSB_EXT_BIAS_SEL              (0x1<<6)	
#define RG_PCIE_CLKDRV_OFFSET              (0x3<<2)	
#define RG_PCIE_CLKDRV_SLEW                (0x3<<0)	

#define RG_PCIE_CLKDRV_AMP                 (0x7<<29)	
#define RG_SSUSB_XTAL_TST_A2DCK_EN         (0x1<<28)	
#define RG_SSUSB_XTAL_MON_EN               (0x1<<27)	
#define RG_SSUSB_XTAL_HYS                  (0x1<<26)	
#define RG_SSUSB_XTAL_TOP_RESERVE          (0xffff<<10)	
#define RG_SSUSB_SYSPLL_PREDIV             (0x3<<8)	
#define RG_SSUSB_SYSPLL_POSDIV             (0x3<<6)	
#define RG_SSUSB_SYSPLL_VCO_DIV_SEL        (0x1<<5)	
#define RG_SSUSB_SYSPLL_VOD_EN             (0x1<<4)	
#define RG_SSUSB_SYSPLL_RST_DLY            (0x3<<2)	
#define RG_SSUSB_SYSPLL_BLP                (0x1<<1)	
#define RG_SSUSB_SYSPLL_BP                 (0x1<<0)	

#define RG_SSUSB_SYSPLL_BR                 (0x1<<31)	
#define RG_SSUSB_SYSPLL_BC                 (0x1<<30)	
#define RG_SSUSB_SYSPLL_MONCK_EN           (0x1<<29)	
#define RG_SSUSB_SYSPLL_MONVC_EN           (0x1<<28)	
#define RG_SSUSB_SYSPLL_MONREF_EN          (0x1<<27)	
#define RG_SSUSB_SYSPLL_SDM_IFM            (0x1<<26)	
#define RG_SSUSB_SYSPLL_SDM_OUT            (0x1<<25)	
#define RG_SSUSB_SYSPLL_BACK_EN            (0x1<<24)	

#define RG_SSUSB_SYSPLL_FBDIV              (0x7fffffff<<1)	
#define RG_SSUSB_SYSPLL_HR_EN              (0x1<<0)	

#define RG_SSUSB_SYSPLL_SDM_DI_EN          (0x1<<31)	
#define RG_SSUSB_SYSPLL_SDM_DI_LS          (0x3<<29)	
#define RG_SSUSB_SYSPLL_SDM_ORD            (0x3<<27)	
#define RG_SSUSB_SYSPLL_SDM_MODE           (0x3<<25)	
#define RG_SSUSB_SYSPLL_RESERVE            (0xff<<17)	
#define RG_SSUSB_SYSPLL_TOP_RESERVE        (0xffff<<1)	

#define RG_SSUSB_TX250MCK_INVB             (0x1<<31)	
#define RG_SSUSB_IDRV_ITAILOP_EN           (0x1<<30)	
#define RG_SSUSB_IDRV_CALIB                (0x3f<<24)	
#define RG_SSUSB_IDEM_BIAS                 (0xf<<20)	
#define RG_SSUSB_TX_R50_FON                (0x1<<19)	
#define RG_SSUSB_TX_SR                     (0x7<<16)	
#define RG_SSUSB_RXDET_RSEL                (0x3<<14)	
#define RG_SSUSB_RXDET_UPDN_FORCE          (0x1<<13)	
#define RG_SSUSB_RXDET_UPDN_SEL            (0x1<<12)	
#define RG_SSUSB_RXDET_VTHSEL_L            (0x3<<10)	
#define RG_SSUSB_RXDET_VTHSEL_H            (0x3<<8)	
#define RG_SSUSB_CKMON_EN                  (0x1<<7)	
#define RG_SSUSB_TX_VLMON_EN               (0x1<<6)	
#define RG_SSUSB_TX_VLMON_SEL              (0x3<<4)	
#define RG_SSUSB_CKMON_SEL                 (0xf<<0)	
...
#define RG_SSUSB_PLL_RESERVE               (0xffff<<16)	
#define RG_SSUSB_PLL_SSC_PRD               (0xffff<<0)	

#define RG_SSUSB_PLL_SSC_PHASE_INI         (0x1<<31)	
#define RG_SSUSB_PLL_SSC_TRI_EN            (0x1<<30)	
#define RG_SSUSB_PLL_CLK_PH_INV            (0x1<<29)	
#define RG_SSUSB_PLL_DDS_LPF_EN            (0x1<<28)	
#define RG_SSUSB_PLL_DDS_RST_SEL           (0x1<<27)	
#define RG_SSUSB_PLL_DDS_VADJ              (0x1<<26)	
#define RG_SSUSB_PLL_DDS_MONEN             (0x1<<25)	
#define RG_SSUSB_PLL_DDS_SEL_EXT           (0x1<<24)	
#define RG_SSUSB_PLL_DDS_PI_PL_EN          (0x1<<23)	
#define RG_SSUSB_PLL_DDS_FRAC_MUTE         (0x7<<20)	
#define RG_SSUSB_PLL_DDS_HF_EN             (0x1<<19)	
#define RG_SSUSB_PLL_DDS_C                 (0x7<<16)	
#define RG_SSUSB_PLL_DDS_PREDIV2           (0x1<<15)	
#define RG_SSUSB_LFPS_LPF                  (0x3<<13)	

#define RG_SSUSB_CDR_PD_DIV_BYPASS         (0x1<<31)	
#define RG_SSUSB_CDR_PD_DIV_SEL            (0x1<<30)	
#define RG_SSUSB_CDR_CPBIAS_SEL            (0x1<<29)	
#define RG_SSUSB_CDR_OSCDET_EN             (0x1<<28)	
#define RG_SSUSB_CDR_MONMUX                (0x1<<27)	
#define RG_SSUSB_CDR_RST_DLY               (0x3<<25)	
#define RG_SSUSB_CDR_RSTB_MANUAL           (0x1<<24)	
#define RG_SSUSB_CDR_BYPASS                (0x3<<22)	
#define RG_SSUSB_CDR_PI_SLEW               (0x3<<20)	
#define RG_SSUSB_CDR_EPEN                  (0x1<<19)	
#define RG_SSUSB_CDR_AUTOK_LOAD            (0x1<<18)	
#define RG_SSUSB_CDR_MONEN                 (0x1<<16)	
#define RG_SSUSB_CDR_MONEN_DIG             (0x1<<15)	
#define RG_SSUSB_CDR_REGOD                 (0x3<<13)	
#define RG_SSUSB_CDR_AUTOK_KS              (0x3<<11)	
#define RG_SSUSB_CDR_AUTOK_KF              (0x3<<9)	
#define RG_SSUSB_RX_DAC_EN                 (0x1<<8)	
#define RG_SSUSB_RX_DAC_PWD                (0x1<<7)	
#define RG_SSUSB_EQ_CURSEL                 (0x1<<6)	
#define RG_SSUSB_RX_DAC_MUX                (0x1f<<1)	
#define RG_SSUSB_RX_R2T_EN                 (0x1<<0)	

#define RG_SSUSB_RX_T2R_EN                 (0x1<<31)	
#define RG_SSUSB_RX_50_LOWER               (0x7<<28)	
#define RG_SSUSB_RX_50_TAR                 (0x3<<26)	
#define RG_SSUSB_RX_SW_CTRL                (0xf<<21)	
#define RG_PCIE_SIGDET_VTH                 (0x3<<19)	
#define RG_PCIE_SIGDET_LPF                 (0x3<<17)	
#define RG_SSUSB_LFPS_MON_EN               (0x1<<16)	
#define RG_SSUSB_RXAFE_DCMON_SEL           (0xf<<12)	
#define RG_SSUSB_RX_P1_ENTRY_PASS          (0x1<<11)	
#define RG_SSUSB_RX_PD_RST                 (0x1<<10)	
#define RG_SSUSB_RX_PD_RST_PASS            (0x1<<9)	

#define RG_SSUSB_CDR_RESERVE               (0xff<<24)	
#define RG_SSUSB_RXAFE_RESERVE             (0xff<<16)	
#define RG_PCIE_RX_RESERVE                 (0xff<<8)	
#define RG_SSUSB_VRT_25M_EN                (0x1<<7)	
#define RG_SSUSB_RX_PD_PICAL_SWAP          (0x1<<6)	
#define RG_SSUSB_RX_DAC_MEAS_EN            (0x1<<5)	
#define RG_SSUSB_MPX_SEL_L0                (0x1<<4)	
#define RG_SSUSB_LFPS_SLCOUT_SEL           (0x1<<3)	
#define RG_SSUSB_LFPS_CMPOUT_SEL           (0x1<<2)	
#define RG_PCIE_SIGDET_HF                  (0x3<<0)	

#define RGS_SSUSB_RX_DEBUG_RESERVE         (0xff<<0)	
...
#define RG_USB20_REFCK_SEL_PE2D            (0x1<<30)	
#define RG_USB20_REFCK_SEL_PE2H            (0x1<<29)	
#define RG_USB20_REFCK_SEL_PE1D            (0x1<<28)	
#define RG_USB20_REFCK_SEL_PE1H            (0x1<<27)	
#define RG_USB20_REFCK_SEL_U3              (0x1<<26)	
#define RG_PCIE_REFCK_DIV4_PE2D            (0x1<<25)	
#define RG_PCIE_REFCK_DIV4_PE2H            (0x1<<24)	
#define RG_PCIE_REFCK_DIV4_PE1D            (0x1<<18)	
#define RG_PCIE_REFCK_DIV4_PE1H            (0x1<<17)	
#define RG_PCIE_REFCK_DIV4_U3              (0x1<<16)	
#define RG_PCIE_MODE_PE2D                  (0x1<<8)	
#define RG_PCIE_MODE_PE2H                  (0x1<<3)	
#define RG_PCIE_MODE_PE1D                  (0x1<<2)	
#define RG_PCIE_MODE_PE1H                  (0x1<<1)	
#define RG_PCIE_MODE_U3                    (0x1<<0)	

#define RG_SSUSB_PLL_DIVEN_PE2D            (0x7<<22)	
#define RG_SSUSB_PLL_DIVEN_PE2H            (0x7<<19)	
#define RG_SSUSB_PLL_DIVEN_PE1D            (0x7<<16)	
#define RG_SSUSB_PLL_DIVEN_PE1H            (0x7<<13)	
#define RG_SSUSB_PLL_DIVEN_U3              (0x7<<10)	
#define RG_SSUSB_PLL_BC_PE2D               (0x3<<8)	
#define RG_SSUSB_PLL_BC_PE2H               (0x3<<6)	
#define RG_SSUSB_PLL_BC_PE1D               (0x3<<4)	
#define RG_SSUSB_PLL_BC_PE1H               (0x3<<2)	
#define RG_SSUSB_PLL_BC_U3                 (0x3<<0)	

#define RG_SSUSB_PLL_BR_PE2D               (0x3<<30)	
#define RG_SSUSB_PLL_BR_PE2H               (0x3<<28)	
#define RG_SSUSB_PLL_BR_PE1D               (0x3<<26)	
#define RG_SSUSB_PLL_BR_PE1H               (0x3<<24)	
#define RG_SSUSB_PLL_BR_U3                 (0x3<<22)	
#define RG_SSUSB_PLL_IC_PE2D               (0xf<<16)	
#define RG_SSUSB_PLL_IC_PE2H               (0xf<<12)	
#define RG_SSUSB_PLL_IC_PE1D               (0xf<<8)	
#define RG_SSUSB_PLL_IC_PE1H               (0xf<<4)	
#define RG_SSUSB_PLL_IC_U3                 (0xf<<0)	

#define RG_SSUSB_PLL_IR_PE2D               (0xf<<24)	
#define RG_SSUSB_PLL_IR_PE2H               (0xf<<16)	
#define RG_SSUSB_PLL_IR_PE1D               (0xf<<8)	
#define RG_SSUSB_PLL_IR_PE1H               (0xf<<4)	
#define RG_SSUSB_PLL_IR_U3                 (0xf<<0)	

#define RG_SSUSB_PLL_BP_PE2D               (0xf<<24)	
#define RG_SSUSB_PLL_BP_PE2H               (0xf<<16)	
#define RG_SSUSB_PLL_BP_PE1D               (0xf<<8)	
#define RG_SSUSB_PLL_BP_PE1H               (0xf<<4)	
#define RG_SSUSB_PLL_BP_U3                 (0xf<<0)	

#define RG_SSUSB_PLL_FBKSEL_PE2D           (0x3<<24)	
#define RG_SSUSB_PLL_FBKSEL_PE2H           (0x3<<16)	
#define RG_SSUSB_PLL_FBKSEL_PE1D           (0x3<<8)	
#define RG_SSUSB_PLL_FBKSEL_PE1H           (0x3<<2)	
#define RG_SSUSB_PLL_FBKSEL_U3             (0x3<<0)	

#define RG_SSUSB_PLL_FBKDIV_PE2H           (0x7f<<24)	
#define RG_SSUSB_PLL_FBKDIV_PE1D           (0x7f<<16)	
#define RG_SSUSB_PLL_FBKDIV_PE1H           (0x7f<<8)	
#define RG_SSUSB_PLL_FBKDIV_U3             (0x7f<<0)	

#define RG_SSUSB_PLL_PREDIV_PE2D           (0x3<<26)	
#define RG_SSUSB_PLL_PREDIV_PE2H           (0x3<<24)	
#define RG_SSUSB_PLL_PREDIV_PE1D           (0x3<<18)	
#define RG_SSUSB_PLL_PREDIV_PE1H           (0x3<<16)	
#define RG_SSUSB_PLL_PREDIV_U3             (0x3<<8)	
#define RG_SSUSB_PLL_FBKDIV_PE2D           (0x7f<<0)	

#define RG_SSUSB_PLL_PCW_NCPO_U3           (0x7fffffff<<0)	

#define RG_SSUSB_PLL_PCW_NCPO_PE1H         (0x7fffffff<<0)	

#define RG_SSUSB_PLL_PCW_NCPO_PE1D         (0x7fffffff<<0)	

#define RG_SSUSB_PLL_PCW_NCPO_PE2H         (0x7fffffff<<0)	

#define RG_SSUSB_PLL_PCW_NCPO_PE2D         (0x7fffffff<<0)	

#define RG_SSUSB_PLL_SSC_DELTA1_PE1H       (0xffff<<16)	
#define RG_SSUSB_PLL_SSC_DELTA1_U3         (0xffff<<0)	

#define RG_SSUSB_PLL_SSC_DELTA1_PE2H       (0xffff<<16)	
#define RG_SSUSB_PLL_SSC_DELTA1_PE1D       (0xffff<<0)	

#define RG_SSUSB_PLL_SSC_DELTA_U3          (0xffffU<<16)	
#define RG_SSUSB_PLL_SSC_DELTA1_PE2D       (0xffff<<0)	

#define RG_SSUSB_PLL_SSC_DELTA_PE1D        (0xffff<<16)	
#define RG_SSUSB_PLL_SSC_DELTA_PE1H        (0xffff<<0)	

#define RG_SSUSB_PLL_SSC_DELTA_PE2D        (0xffff<<16)	
#define RG_SSUSB_PLL_SSC_DELTA_PE2H        (0xffff<<0)	

#define RG_SSUSB_PLL_REFCKDIV_PE2D         (0x1<<25)	
#define RG_SSUSB_PLL_REFCKDIV_PE2H         (0x1<<24)	
#define RG_SSUSB_PLL_REFCKDIV_PE1D         (0x1<<16)	
#define RG_SSUSB_PLL_REFCKDIV_PE1H         (0x1<<8)	
#define RG_SSUSB_PLL_REFCKDIV_U3           (0x1<<0)	

#define RG_SSUSB_CDR_BPA_PE2D              (0x3<<24)	
#define RG_SSUSB_CDR_BPA_PE2H              (0x3<<16)	
#define RG_SSUSB_CDR_BPA_PE1D              (0x3<<10)	
#define RG_SSUSB_CDR_BPA_PE1H              (0x3<<8)	
#define RG_SSUSB_CDR_BPA_U3                (0x3<<0)	

#define RG_SSUSB_CDR_BPB_PE2D              (0x7<<24)	
#define RG_SSUSB_CDR_BPB_PE2H              (0x7<<16)	
#define RG_SSUSB_CDR_BPB_PE1D              (0x7<<6)	
#define RG_SSUSB_CDR_BPB_PE1H              (0x7<<3)	
#define RG_SSUSB_CDR_BPB_U3                (0x7<<0)	

#define RG_SSUSB_CDR_BR_PE2D               (0x7<<24)	
#define RG_SSUSB_CDR_BR_PE2H               (0x7<<16)	
#define RG_SSUSB_CDR_BR_PE1D               (0x7<<6)	
#define RG_SSUSB_CDR_BR_PE1H               (0x7<<3)	
#define RG_SSUSB_CDR_BR_U3                 (0x7<<0)	

#define RG_SSUSB_CDR_FBDIV_PE2H            (0x7f<<24)	
#define RG_SSUSB_CDR_FBDIV_PE1D            (0x7f<<16)	
#define RG_SSUSB_CDR_FBDIV_PE1H            (0x7f<<8)	
#define RG_SSUSB_CDR_FBDIV_U3              (0x7f<<0)	
...
#define RG_SSUSB_RX_CMPWD_PE2D             (0x1<<26)	
#define RG_SSUSB_RX_CMPWD_PE2H             (0x1<<25)	
#define RG_SSUSB_RX_CMPWD_PE1D             (0x1<<24)	
#define RG_SSUSB_RX_CMPWD_PE1H             (0x1<<23)	
#define RG_SSUSB_RX_CMPWD_U3               (0x1<<16)	
#define RG_SSUSB_EQ_RSTEP2_PE2D            (0x3<<8)	
#define RG_SSUSB_EQ_RSTEP2_PE2H            (0x3<<6)	
#define RG_SSUSB_EQ_RSTEP2_PE1D            (0x3<<4)	
#define RG_SSUSB_EQ_RSTEP2_PE1H            (0x3<<2)	
#define RG_SSUSB_EQ_RSTEP2_U3              (0x3<<0)	
...
#define RG_SSUSB_P_P3_TX_NG                (0x1<<31)	
#define RG_SSUSB_TSEQ_EN                   (0x1<<30)	
#define RG_SSUSB_TSEQ_POLEN                (0x1<<29)	
#define RG_SSUSB_TSEQ_POL                  (0x1<<28)	
#define RG_SSUSB_P_P3_PCLK_NG              (0x1<<27)	
#define RG_SSUSB_TSEQ_TH                   (0x7<<24)	
#define RG_SSUSB_PRBS_BERTH                (0xff<<16)	
#define RG_SSUSB_DISABLE_PHY_U2_ON         (0x1<<15)	
#define RG_SSUSB_DISABLE_PHY_U2_OFF        (0x1<<14)	
#define RG_SSUSB_PRBS_EN                   (0x1<<13)	
#define RG_SSUSB_BPSLOCK                   (0x1<<12)	
#define RG_SSUSB_RTCOMCNT                  (0xf<<8)	
#define RG_SSUSB_COMCNT                    (0xf<<4)	
#define RG_SSUSB_PRBSEL_CALIB              (0xf<<0)	

#define RG_SSUSB_SLEEP_EN                  (0x1<<31)	
#define RG_SSUSB_PRBSEL_PCS                (0x7<<28)	
#define RG_SSUSB_TXLFPS_PRD                (0xf<<24)	
#define RG_SSUSB_P_RX_P0S_CK               (0x1<<23)	
#define RG_SSUSB_P_TX_P0S_CK               (0x1<<22)	
#define RG_SSUSB_PDNCTL                    (0x3f<<16)	
#define RG_SSUSB_TX_DRV_EN                 (0x1<<15)	
#define RG_SSUSB_TX_DRV_SEL                (0x1<<14)	
#define RG_SSUSB_TX_DRV_DLY                (0x3f<<8)	
#define RG_SSUSB_BERT_EN                   (0x1<<7)	
#define RG_SSUSB_SCP_TH                    (0x7<<4)	
#define RG_SSUSB_SCP_EN                    (0x1<<3)	
#define RG_SSUSB_RXANSIDEC_TEST            (0x7<<0)	

#define RG_SSUSB_LFPS_PWD                  (0x1<<30)	
#define RG_SSUSB_FORCE_LFPS_PWD            (0x1<<29)	
#define RG_SSUSB_RXLFPS_OVF                (0x1f<<24)	
#define RG_SSUSB_P3_ENTRY_SEL              (0x1<<23)	
#define RG_SSUSB_P3_ENTRY                  (0x1<<22)	
#define RG_SSUSB_RXLFPS_CDRSEL             (0x3<<20)	
#define RG_SSUSB_RXLFPS_CDRTH              (0xf<<16)	
#define RG_SSUSB_LOCK5G_BLOCK              (0x1<<15)	
#define RG_SSUSB_TFIFO_EXT_D_SEL           (0x1<<14)	
#define RG_SSUSB_TFIFO_NO_EXTEND           (0x1<<13)	
#define RG_SSUSB_RXLFPS_LOB                (0x1f<<8)	
#define RG_SSUSB_TXLFPS_EN                 (0x1<<7)	
#define RG_SSUSB_TXLFPS_SEL                (0x1<<6)	
#define RG_SSUSB_RXLFPS_CDRLOCK            (0x1<<5)	
#define RG_SSUSB_RXLFPS_UPB                (0x1f<<0)	

#define RG_SSUSB_RX_IMP_BIAS               (0xf<<28)	
#define RG_SSUSB_TX_IMP_BIAS               (0xf<<24)	
#define RG_SSUSB_FWAKE_TH                  (0x3f<<16)	
#define RG_SSUSB_P1_ENTRY_SEL              (0x1<<14)	
#define RG_SSUSB_P1_ENTRY                  (0x1<<13)	
#define RG_SSUSB_RXLFPS_UDF                (0x1f<<8)	
#define RG_SSUSB_RXLFPS_P0IDLETH           (0xff<<0)	
...
#define RG_SSUSB_TXPLL_DDSEN_CYC           (0x1f<<27)	
#define RG_SSUSB_TXPLL_ON                  (0x1<<26)	
#define RG_SSUSB_FORCE_TXPLLON             (0x1<<25)	
#define RG_SSUSB_TXPLL_STBCYC              (0x1ff<<16)	
#define RG_SSUSB_TXPLL_NCPOCHG_CYC         (0xf<<12)	
#define RG_SSUSB_TXPLL_NCPOEN_CYC          (0x3<<10)	
#define RG_SSUSB_TXPLL_DDSRSTB_CYC         (0x7<<0)	

#define RG_SSUSB_PLL_NCPO_EN               (0x1<<31)	
#define RG_SSUSB_PLL_FIFO_START_MAN        (0x1<<30)	
#define RG_SSUSB_PLL_NCPO_CHG              (0x1<<28)	
#define RG_SSUSB_PLL_DDS_RSTB              (0x1<<27)	
#define RG_SSUSB_PLL_DDS_PWDB              (0x1<<26)	
#define RG_SSUSB_PLL_DDSEN                 (0x1<<25)	
#define RG_SSUSB_PLL_AUTOK_VCO             (0x1<<24)	
#define RG_SSUSB_PLL_PWD                   (0x1<<23)	
#define RG_SSUSB_RX_AFE_PWD                (0x1<<22)	
#define RG_SSUSB_PLL_TCADJ                 (0x3f<<16)	
#define RG_SSUSB_FORCE_CDR_TCADJ           (0x1<<15)	
#define RG_SSUSB_FORCE_CDR_AUTOK_VCO       (0x1<<14)	
#define RG_SSUSB_FORCE_CDR_PWD             (0x1<<13)	
#define RG_SSUSB_FORCE_PLL_NCPO_EN         (0x1<<12)	
#define RG_SSUSB_FORCE_PLL_FIFO_START_MAN  (0x1<<11)	
#define RG_SSUSB_FORCE_PLL_NCPO_CHG        (0x1<<9)	
#define RG_SSUSB_FORCE_PLL_DDS_RSTB        (0x1<<8)	
#define RG_SSUSB_FORCE_PLL_DDS_PWDB        (0x1<<7)	
#define RG_SSUSB_FORCE_PLL_DDSEN           (0x1<<6)	
#define RG_SSUSB_FORCE_PLL_TCADJ           (0x1<<5)	
#define RG_SSUSB_FORCE_PLL_AUTOK_VCO       (0x1<<4)	
#define RG_SSUSB_FORCE_PLL_PWD             (0x1<<3)	
#define RG_SSUSB_FLT_1_DISPERR_B           (0x1<<2)	

#define RG_SSUSB_TX_LFPS_EN                (0x1<<31)	
#define RG_SSUSB_FORCE_TX_LFPS_EN          (0x1<<30)	
#define RG_SSUSB_TX_LFPS                   (0x1<<29)	
#define RG_SSUSB_FORCE_TX_LFPS             (0x1<<28)	
#define RG_SSUSB_RXPLL_STB                 (0x1<<27)	
#define RG_SSUSB_TXPLL_STB                 (0x1<<26)	
#define RG_SSUSB_FORCE_RXPLL_STB           (0x1<<25)	
#define RG_SSUSB_FORCE_TXPLL_STB           (0x1<<24)	
#define RG_SSUSB_RXPLL_REFCKSEL            (0x1<<16)	
#define RG_SSUSB_RXPLL_STBMODE             (0x1<<11)	
#define RG_SSUSB_RXPLL_ON                  (0x1<<10)	
#define RG_SSUSB_FORCE_RXPLLON             (0x1<<9)	
#define RG_SSUSB_FORCE_RX_AFE_PWD          (0x1<<8)	
#define RG_SSUSB_CDR_AUTOK_VCO             (0x1<<7)	
#define RG_SSUSB_CDR_PWD                   (0x1<<6)	
#define RG_SSUSB_CDR_TCADJ                 (0x3f<<0)	

#define RG_SSUSB_RX_FL_TARGET              (0xffff<<16)	
#define RG_SSUSB_RX_FL_CYCLECNT            (0xffff<<0)	

#define RG_SSUSB_RX_EQ_RST                 (0x1<<31)	
#define RG_SSUSB_RX_EQ_RST_SEL             (0x1<<30)	
#define RG_SSUSB_RXVAL_RST                 (0x1<<29)	
#define RG_SSUSB_RXVAL_CNT                 (0x1f<<24)	
#define RG_SSUSB_CDROS_EN                  (0x1<<18)	
#define RG_SSUSB_CDR_LCKOP                 (0x3<<16)	
#define RG_SSUSB_RX_FL_LOCKTH              (0xf<<8)	
#define RG_SSUSB_RX_FL_OFFSET              (0xff<<0)	

#define RG_SSUSB_T2RLB_BERTH               (0xff<<24)	
#define RG_SSUSB_T2RLB_PAT                 (0xff<<16)	
#define RG_SSUSB_T2RLB_EN                  (0x1<<15)	
#define RG_SSUSB_T2RLB_BPSCRAMB            (0x1<<14)	
#define RG_SSUSB_T2RLB_SERIAL              (0x1<<13)	
#define RG_SSUSB_T2RLB_MODE                (0x3<<11)	
#define RG_SSUSB_RX_SAOSC_EN               (0x1<<10)	
#define RG_SSUSB_RX_SAOSC_EN_SEL           (0x1<<9)	
#define RG_SSUSB_RX_DFE_OPTION             (0x1<<8)	
#define RG_SSUSB_RX_DFE_EN                 (0x1<<7)	
#define RG_SSUSB_RX_DFE_EN_SEL             (0x1<<6)	
#define RG_SSUSB_RX_EQ_EN                  (0x1<<5)	
#define RG_SSUSB_RX_EQ_EN_SEL              (0x1<<4)	
#define RG_SSUSB_RX_SAOSC_RST              (0x1<<3)	
#define RG_SSUSB_RX_SAOSC_RST_SEL          (0x1<<2)	
#define RG_SSUSB_RX_DFE_RST                (0x1<<1)	
#define RG_SSUSB_RX_DFE_RST_SEL            (0x1<<0)	

#define RG_SSUSB_EQTRAIN_CH_MODE           (0x1<<28)	
#define RG_SSUSB_PRB_OUT_CPPAT             (0x1<<27)	
#define RG_SSUSB_BPANSIENC                 (0x1<<26)	
#define RG_SSUSB_VALID_EN                  (0x1<<25)	
#define RG_SSUSB_EBUF_SRST                 (0x1<<24)	
#define RG_SSUSB_K_EMP                     (0xf<<20)	
#define RG_SSUSB_K_FUL                     (0xf<<16)	
#define RG_SSUSB_T2RLB_BDATRST             (0xf<<12)	
#define RG_SSUSB_P_T2RLB_SKP_EN            (0x1<<10)	
#define RG_SSUSB_T2RLB_PATMODE             (0x3<<8)	
#define RG_SSUSB_T2RLB_TSEQCNT             (0xff<<0)	

#define RG_SSUSB_CPPAT_PROGRAM_EN          (0x1<<24)	
#define RG_SSUSB_CPPAT_TOZ                 (0x3<<21)	
#define RG_SSUSB_CPPAT_PRBS_EN             (0x1<<20)	
#define RG_SSUSB_CPPAT_OUT_TMP2            (0xf<<16)	
#define RG_SSUSB_CPPAT_OUT_TMP1            (0xff<<8)	
#define RG_SSUSB_CPPAT_OUT_TMP0            (0xff<<0)	

#define RG_SSUSB_CDR_TCADJ_MINUS           (0x1<<31)	
#define RG_SSUSB_P_CDROS_EN                (0x1<<30)	
#define RG_SSUSB_P_P2_TX_DRV_DIS           (0x1<<28)	
#define RG_SSUSB_CDR_TCADJ_OFFSET          (0x7<<24)	
#define RG_SSUSB_PLL_TCADJ_MINUS           (0x1<<23)	
#define RG_SSUSB_FORCE_PLL_BIAS_LPF_EN     (0x1<<20)	
#define RG_SSUSB_PLL_BIAS_LPF_EN           (0x1<<19)	
#define RG_SSUSB_PLL_TCADJ_OFFSET          (0x7<<16)	
#define RG_SSUSB_FORCE_PLL_SSCEN           (0x1<<15)	
#define RG_SSUSB_PLL_SSCEN                 (0x1<<14)	
#define RG_SSUSB_FORCE_CDR_PI_PWD          (0x1<<13)	
#define RG_SSUSB_CDR_PI_PWD                (0x1<<12)	
#define RG_SSUSB_CDR_PI_MODE               (0x1<<11)	
#define RG_SSUSB_TXPLL_SSCEN_CYC           (0x3ff<<0)	

#define RG_SSUSB_EBUFCTL                   (0xffffffff<<0)	

#define RG_SSUSB_RXTERMINATION             (0x1<<30)	
#define RG_SSUSB_RXEQTRAINING              (0x1<<29)	
#define RG_SSUSB_RXPOLARITY                (0x1<<28)	
#define RG_SSUSB_TXDEEMPH                  (0x3<<26)	
#define RG_SSUSB_POWERDOWN                 (0x3<<24)	
#define RG_SSUSB_TXONESZEROS               (0x1<<23)	
#define RG_SSUSB_TXELECIDLE                (0x1<<22)	
#define RG_SSUSB_TXDETECTRX                (0x1<<21)	
#define RG_SSUSB_PIPE_SEL                  (0x1<<20)	
#define RG_SSUSB_TXDATAK                   (0xf<<16)	
#define RG_SSUSB_CDR_STABLE_SEL            (0x1<<15)	
#define RG_SSUSB_CDR_STABLE                (0x1<<14)	
#define RG_SSUSB_CDR_RSTB_SEL              (0x1<<13)	
#define RG_SSUSB_CDR_RSTB                  (0x1<<12)	
#define RG_SSUSB_FRC_PIPE_POWERDOWN        (0x1<<11)	
#define RG_SSUSB_P_TXBCN_DIS               (0x1<<6)	
#define RG_SSUSB_P_ERROR_SEL               (0x3<<4)	
#define RG_SSUSB_TXMARGIN                  (0x7<<1)	
#define RG_SSUSB_TXCOMPLIANCE              (0x1<<0)	

#define RG_SSUSB_TXDATA                    (0xffffffff<<0)	

#define RG_SSUSB_CDROS_CNT                 (0x3f<<24)	
#define RG_SSUSB_T2RLB_BER_EN              (0x1<<16)	
#define RG_SSUSB_T2RLB_BER_RATE            (0xffff<<0)	

#define RG_SSUSB_RFIFO_IMPLAT              (0x1<<27)	
#define RG_SSUSB_TFIFO_PSEL                (0x7<<24)	
#define RG_SSUSB_CKGEN_PSEL                (0x3<<8)	
#define RG_SSUSB_RXCK_INV                  (0x1<<0)	

#define RG_SSUSB_PRB_SEL                   (0xffff<<16)	
#define RG_SSUSB_RXPLL_STBCYC              (0x7ff<<0)	

#define RG_SSUSB_PHYD_RESERVE              (0xffffffff<<0)	

#define RG_SSUSB_CDR_BIC_LTR               (0xf<<28)	
#define RG_SSUSB_CDR_BIC_LTD0              (0xf<<24)	
#define RG_SSUSB_CDR_BC_LTD1               (0x1f<<16)	
#define RG_SSUSB_CDR_BC_LTR                (0x1f<<8)	
#define RG_SSUSB_CDR_BC_LTD0               (0x1f<<0)	
...
#define RG_SSUSB_FORCE_CDR_BAND_5G         (0x1<<28)	
#define RG_SSUSB_FORCE_CDR_BAND_2P5G       (0x1<<27)	
#define RG_SSUSB_FORCE_PLL_BAND_5G         (0x1<<26)	
#define RG_SSUSB_FORCE_PLL_BAND_2P5G       (0x1<<25)	
#define RG_SSUSB_P_EQ_T_SEL                (0x3ff<<15)	
#define RG_SSUSB_PLL_ISO_EN_CYC            (0x3ff<<5)	
#define RG_SSUSB_PLLBAND_RECAL             (0x1<<4)	
#define RG_SSUSB_PLL_DDS_ISO_EN            (0x1<<3)	
#define RG_SSUSB_FORCE_PLL_DDS_ISO_EN      (0x1<<2)	
#define RG_SSUSB_PLL_DDS_PWR_ON            (0x1<<1)	
#define RG_SSUSB_FORCE_PLL_DDS_PWR_ON      (0x1<<0)	

#define RG_SSUSB_CDR_BAND_5G               (0xff<<24)	
#define RG_SSUSB_CDR_BAND_2P5G             (0xff<<16)	
#define RG_SSUSB_PLL_BAND_5G               (0xff<<8)	
#define RG_SSUSB_PLL_BAND_2P5G             (0xff<<0)	

#define RG_SSUSB_P_BCN_OBS_PRD             (0xffff<<16)	
#define RG_SSUSB_U_BCN_OBS_PRD             (0xffff<<0)	

#define RG_SSUSB_P_BCN_OBS_SEL             (0xfff<<16)	
#define RG_SSUSB_BCN_DET_DIS               (0x1<<12)	
#define RG_SSUSB_U_BCN_OBS_SEL             (0xfff<<0)	

#define RG_SSUSB_EQ_DLHL_LFI               (0x7f<<24)	
#define RG_SSUSB_EQ_DHHL_LFI               (0x7f<<16)	
#define RG_SSUSB_EQ_DD0HOS_LFI             (0x7f<<8)	
#define RG_SSUSB_EQ_DD0LOS_LFI             (0x7f<<0)	

#define RG_SSUSB_EQ_DD1HOS_LFI             (0x7f<<24)	
#define RG_SSUSB_EQ_DD1LOS_LFI             (0x7f<<16)	
#define RG_SSUSB_EQ_DE0OS_LFI              (0x7f<<8)	
#define RG_SSUSB_EQ_DE1OS_LFI              (0x7f<<0)	

#define RG_SSUSB_EQ_DLHLOS_LFI             (0x7f<<24)	
#define RG_SSUSB_EQ_DHHLOS_LFI             (0x7f<<16)	
#define RG_SSUSB_EQ_STOPTIME               (0x1<<14)	
#define RG_SSUSB_EQ_DHHL_LF_SEL            (0x7<<11)	
#define RG_SSUSB_EQ_DSAOS_LF_SEL           (0x7<<8)	
#define RG_SSUSB_EQ_STARTTIME              (0x3<<6)	
#define RG_SSUSB_EQ_DLEQ_LF_SEL            (0x7<<3)	
#define RG_SSUSB_EQ_DLHL_LF_SEL            (0x7<<0)	

#define RG_SSUSB_EQ_DLEQ_LFI_GEN2          (0xf<<28)	
#define RG_SSUSB_EQ_DLEQ_LFI_GEN1          (0xf<<24)	
#define RG_SSUSB_EQ_DEYE0OS_LFI            (0x7f<<16)	
#define RG_SSUSB_EQ_DEYE1OS_LFI            (0x7f<<8)	
#define RG_SSUSB_EQ_TRI_DET_EN             (0x1<<7)	
#define RG_SSUSB_EQ_TRI_DET_TH             (0x7f<<0)	

#define RG_SSUSB_EQ_EYE_XOFFSET            (0x7f<<25)	
#define RG_SSUSB_EQ_EYE_MON_EN             (0x1<<24)	
#define RG_SSUSB_EQ_EYE0_Y                 (0x7f<<16)	
#define RG_SSUSB_EQ_EYE1_Y                 (0x7f<<8)	
#define RG_SSUSB_EQ_PILPO_ROUT             (0x1<<7)	
#define RG_SSUSB_EQ_PI_KPGAIN              (0x7<<4)	
#define RG_SSUSB_EQ_EYE_CNT_EN             (0x1<<3)	

#define RG_SSUSB_EQ_SIGDET                 (0x7f<<24)	
#define RG_SSUSB_EQ_EYE_MASK               (0x3ff<<7)	

#define RG_SSUSB_EQ_RX500M_CK_SEL          (0x1<<31)	
#define RG_SSUSB_EQ_SD_CNT1                (0x3f<<24)	
#define RG_SSUSB_EQ_ISIFLAG_SEL            (0x3<<22)	
#define RG_SSUSB_EQ_SD_CNT0                (0x3f<<16)	

#define RG_SSUSB_EQ_LEQMAX                 (0xf<<28)	
#define RG_SSUSB_EQ_DFEX_EN                (0x1<<27)	
#define RG_SSUSB_EQ_DFEX_LF_SEL            (0x7<<24)	
#define RG_SSUSB_EQ_CHK_EYE_H              (0x1<<23)	
#define RG_SSUSB_EQ_PIEYE_INI              (0x7f<<16)	
#define RG_SSUSB_EQ_PI90_INI               (0x7f<<8)	
#define RG_SSUSB_EQ_PI0_INI                (0x7f<<0)	

#define RG_SSUSB_EQ_REV                    (0xffff<<16)	
#define RG_SSUSB_EQ_DFEYEN_DUR             (0x7<<12)	
#define RG_SSUSB_EQ_DFEXEN_DUR             (0x7<<8)	
#define RG_SSUSB_EQ_DFEX_RST               (0x1<<7)	
#define RG_SSUSB_EQ_GATED_RXD_B            (0x1<<6)	
#define RG_SSUSB_EQ_PI90CK_SEL             (0x3<<4)	
#define RG_SSUSB_EQ_DFEX_DIS               (0x1<<2)	
#define RG_SSUSB_EQ_DFEYEN_STOP_DIS        (0x1<<1)	
#define RG_SSUSB_EQ_DFEXEN_SEL             (0x1<<0)	

#define RG_SSUSB_EQ_MON_SEL                (0x1f<<24)	
#define RG_SSUSB_EQ_LEQOSC_DLYCNT          (0x7<<16)	
#define RG_SSUSB_EQ_DLEQOS_LFI             (0x1f<<8)	
#define RG_SSUSB_EQ_DFE_TOG                (0x1<<2)	
#define RG_SSUSB_EQ_LEQ_STOP_TO            (0x3<<0)	

#define RG_SSUSB_EQ_RESERVED               (0xffffffff<<0)	

#define RGS_SSUSB_BERT_BERC                (0xffff<<16)	
#define RGS_SSUSB_LFPS                     (0xf<<12)	
#define RGS_SSUSB_TRAINDEC                 (0x7<<8)	
#define RGS_SSUSB_SCP_PAT                  (0xff<<0)	

#define RGS_SSUSB_RX_FL_OUT                (0xffff<<0)	

#define RGS_SSUSB_T2RLB_ERRCNT             (0xffff<<16)	
#define RGS_SSUSB_RETRACK                  (0xf<<12)	
#define RGS_SSUSB_RXPLL_LOCK               (0x1<<10)	
#define RGS_SSUSB_CDR_VCOCAL_CPLT_D        (0x1<<9)	
#define RGS_SSUSB_PLL_VCOCAL_CPLT_D        (0x1<<8)	
#define RGS_SSUSB_PDNCTL                   (0xff<<0)	

#define RGS_SSUSB_TSEQ_ERRCNT              (0xffff<<16)	
#define RGS_SSUSB_PRBS_ERRCNT              (0xffff<<0)	

#define RGS_SSUSB_RX_LSLOCK_CNT            (0xf<<24)	
#define RGS_SSUSB_SCP_DETCNT               (0xff<<16)	
#define RGS_SSUSB_TSEQ_DETCNT              (0xffff<<0)	

#define RGS_SSUSB_EBUFMSG                  (0xffff<<16)	
#define RGS_SSUSB_BERT_LOCK                (0x1<<15)	
#define RGS_SSUSB_SCP_DET                  (0x1<<14)	
#define RGS_SSUSB_TSEQ_DET                 (0x1<<13)	
#define RGS_SSUSB_EBUF_UDF                 (0x1<<12)	
#define RGS_SSUSB_EBUF_OVF                 (0x1<<11)	
#define RGS_SSUSB_PRBS_PASSTH              (0x1<<10)	
#define RGS_SSUSB_PRBS_PASS                (0x1<<9)	
#define RGS_SSUSB_PRBS_LOCK                (0x1<<8)	
#define RGS_SSUSB_T2RLB_ERR                (0x1<<6)	
#define RGS_SSUSB_T2RLB_PASSTH             (0x1<<5)	
#define RGS_SSUSB_T2RLB_PASS               (0x1<<4)	
#define RGS_SSUSB_T2RLB_LOCK               (0x1<<3)	
#define RGS_SSUSB_RX_IMPCAL_DONE           (0x1<<2)	
#define RGS_SSUSB_TX_IMPCAL_DONE           (0x1<<1)	
#define RGS_SSUSB_RXDETECTED               (0x1<<0)	

#define RGS_SSUSB_SIGCAL_DONE              (0x1<<30)	
#define RGS_SSUSB_SIGCAL_CAL_OUT           (0x1<<29)	
#define RGS_SSUSB_SIGCAL_OFFSET            (0x1f<<24)	
#define RGS_SSUSB_RX_IMP_SEL               (0x1f<<16)	
#define RGS_SSUSB_TX_IMP_SEL               (0x1f<<8)	
#define RGS_SSUSB_TFIFO_MSG                (0xf<<4)	
#define RGS_SSUSB_RFIFO_MSG                (0xf<<0)	

#define RGS_SSUSB_FT_OUT                   (0xff<<8)	
#define RGS_SSUSB_PRB_OUT                  (0xff<<0)	

#define RGS_SSUSB_EQ_DCLEQ                 (0xf<<24)	
#define RGS_SSUSB_EQ_DCD0H                 (0x7f<<16)	
#define RGS_SSUSB_EQ_DCD0L                 (0x7f<<8)	
#define RGS_SSUSB_EQ_DCD1H                 (0x7f<<0)	

#define RGS_SSUSB_EQ_DCD1L                 (0x7f<<24)	
#define RGS_SSUSB_EQ_DCE0                  (0x7f<<16)	
#define RGS_SSUSB_EQ_DCE1                  (0x7f<<8)	
#define RGS_SSUSB_EQ_DCHHL                 (0x7f<<0)	

#define RGS_SSUSB_EQ_LEQ_STOP              (0x1<<31)	
#define RGS_SSUSB_EQ_DCLHL                 (0x7f<<24)	
#define RGS_SSUSB_EQ_STATUS                (0xff<<16)	
#define RGS_SSUSB_EQ_DCEYE0                (0x7f<<8)	
#define RGS_SSUSB_EQ_DCEYE1                (0x7f<<0)	

#define RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_0  (0xfffff<<0)	

#define RGS_SSUSB_EQ_EYE_MONITOR_ERRCNT_1  (0xfffff<<0)	

#define RGS_SSUSB_EQ_DCLEQOS               (0x1f<<8)	
#define RGS_SSUSB_EQ_EYE_CNT_RDY           (0x1<<7)	
#define RGS_SSUSB_EQ_PILPO                 (0x7f<<0)	

#define RG_SSUSB_CPPAT_OUT_H_TMP2          (0xf<<16)	
#define RG_SSUSB_CPPAT_OUT_H_TMP1          (0xff<<8)	
#define RG_SSUSB_CPPAT_OUT_H_TMP0          (0xff<<0)	

#define RG_SSUSB_EQ_LEQ_SHIFT              (0x7<<24)	
#define RG_SSUSB_EQ_EYE_CNT                (0xfffff<<0)	

#define RGS_SSUSB_CDR_BAND_5G              (0xff<<24)	
#define RGS_SSUSB_CDR_BAND_2P5G            (0xff<<16)	
#define RGS_SSUSB_PLL_BAND_5G              (0xff<<8)	
#define RGS_SSUSB_PLL_BAND_2P5G            (0xff<<0)	

#define RGS_SSUSB_CDR_VCOCAL_FAIL          (0x1<<24)	
#define RGS_SSUSB_CDR_VCOCAL_STATE         (0xff<<16)	
#define RGS_SSUSB_PLL_VCOCAL_FAIL          (0x1<<8)	
#define RGS_SSUSB_PLL_VCOCAL_STATE         (0xff<<0)	
...
#define RG_SSUSB_PCIE2_K_EMP               (0xf<<28)	
#define RG_SSUSB_PCIE2_K_FUL               (0xf<<24)	
#define RG_SSUSB_TX_EIDLE_LP_EN            (0x1<<17)	
#define RG_SSUSB_FORCE_TX_EIDLE_LP_EN      (0x1<<16)	
#define RG_SSUSB_SIGDET_EN                 (0x1<<15)	
#define RG_SSUSB_FORCE_SIGDET_EN           (0x1<<14)	
#define RG_SSUSB_CLKRX_EN                  (0x1<<13)	
#define RG_SSUSB_FORCE_CLKRX_EN            (0x1<<12)	
#define RG_SSUSB_CLKTX_EN                  (0x1<<11)	
#define RG_SSUSB_FORCE_CLKTX_EN            (0x1<<10)	
#define RG_SSUSB_CLK_REQ_N_I               (0x1<<9)	
#define RG_SSUSB_FORCE_CLK_REQ_N_I         (0x1<<8)	
#define RG_SSUSB_RATE                      (0x1<<6)	
#define RG_SSUSB_FORCE_RATE                (0x1<<5)	
#define RG_SSUSB_PCIE_MODE_SEL             (0x1<<4)	
#define RG_SSUSB_FORCE_PCIE_MODE_SEL       (0x1<<3)	
#define RG_SSUSB_PHY_MODE                  (0x3<<1)	
#define RG_SSUSB_FORCE_PHY_MODE            (0x1<<0)	

#define RG_SSUSB_FORCE_IDRV_6DB            (0x1<<30)	
#define RG_SSUSB_IDRV_6DB                  (0x3f<<24)	
#define RG_SSUSB_FORCE_IDEM_3P5DB          (0x1<<22)	
#define RG_SSUSB_IDEM_3P5DB                (0x3f<<16)	
#define RG_SSUSB_FORCE_IDRV_3P5DB          (0x1<<14)	
#define RG_SSUSB_IDRV_3P5DB                (0x3f<<8)	
#define RG_SSUSB_FORCE_IDRV_0DB            (0x1<<6)	
#define RG_SSUSB_IDRV_0DB                  (0x3f<<0)	

#define RG_SSUSB_TX_BIASI                  (0x7<<25)	
#define RG_SSUSB_FORCE_TX_BIASI_EN         (0x1<<24)	
#define RG_SSUSB_TX_BIASI_EN               (0x1<<16)	
#define RG_SSUSB_FORCE_TX_BIASI            (0x1<<13)	
#define RG_SSUSB_FORCE_IDEM_6DB            (0x1<<8)	
#define RG_SSUSB_IDEM_6DB                  (0x3f<<0)	

#define RG_SSUSB_G1_CDR_BIC_LTR            (0xf<<28)	
#define RG_SSUSB_G1_CDR_BIC_LTD0           (0xf<<24)	
#define RG_SSUSB_G1_CDR_BC_LTD1            (0x1f<<16)	
#define RG_SSUSB_G1_L1SS_CDR_BW_SEL        (0x3<<13)	
#define RG_SSUSB_G1_CDR_BC_LTR             (0x1f<<8)	
#define RG_SSUSB_G1_CDR_BW_SEL             (0x3<<5)	
#define RG_SSUSB_G1_CDR_BC_LTD0            (0x1f<<0)	

#define RG_SSUSB_G1_CDR_BIR_LTD1           (0x1f<<24)	
#define RG_SSUSB_G1_CDR_BIR_LTR            (0x1f<<16)	
#define RG_SSUSB_G1_CDR_BIR_LTD0           (0x1f<<8)	
#define RG_SSUSB_G1_CDR_BIC_LTD1           (0xf<<0)	

#define RG_SSUSB_G2_CDR_BIC_LTR            (0xf<<28)	
#define RG_SSUSB_G2_CDR_BIC_LTD0           (0xf<<24)	
#define RG_SSUSB_G2_CDR_BC_LTD1            (0x1f<<16)	
#define RG_SSUSB_G2_L1SS_CDR_BW_SEL        (0x3<<13)	
#define RG_SSUSB_G2_CDR_BC_LTR             (0x1f<<8)	
#define RG_SSUSB_G2_CDR_BW_SEL             (0x3<<5)	
#define RG_SSUSB_G2_CDR_BC_LTD0            (0x1f<<0)	

#define RG_SSUSB_G2_CDR_BIR_LTD1           (0x1f<<24)	
#define RG_SSUSB_G2_CDR_BIR_LTR            (0x1f<<16)	
#define RG_SSUSB_G2_CDR_BIR_LTD0           (0x1f<<8)	
#define RG_SSUSB_G2_CDR_BIC_LTD1           (0xf<<0)	

#define RG_SSUSB_P_SIGDET_FLT_DIS          (0x1<<31)	
#define RG_SSUSB_P_SIGDET_FLT_G2_DEAST_SEL (0x7f<<24)	
#define RG_SSUSB_P_SIGDET_FLT_G1_DEAST_SEL (0x7f<<16)	
#define RG_SSUSB_P_SIGDET_FLT_P2_AST_SEL   (0x7f<<8)	
#define RG_SSUSB_P_SIGDET_FLT_PX_AST_SEL   (0x7f<<0)	

#define RG_SSUSB_P_SIGDET_RX_VAL_S         (0x1<<29)	
#define RG_SSUSB_P_SIGDET_L0S_DEAS_SEL     (0x1<<28)	
#define RG_SSUSB_P_SIGDET_L0_EXIT_S        (0x1<<27)	
#define RG_SSUSB_P_SIGDET_L0S_EXIT_T_S     (0x3<<25)	
#define RG_SSUSB_P_SIGDET_L0S_EXIT_S       (0x1<<24)	
#define RG_SSUSB_P_SIGDET_L0S_ENTRY_S      (0x1<<16)	
#define RG_SSUSB_P_SIGDET_PRB_SEL          (0x1<<10)	
#define RG_SSUSB_P_SIGDET_BK_SIG_T         (0x3<<8)	
#define RG_SSUSB_P_SIGDET_P2_RXLFPS        (0x1<<6)	
#define RG_SSUSB_P_SIGDET_NON_BK_AD        (0x1<<5)	
#define RG_SSUSB_P_SIGDET_BK_B_RXEQ        (0x1<<4)	
#define RG_SSUSB_P_SIGDET_G2_KO_SEL        (0x3<<2)	
#define RG_SSUSB_P_SIGDET_G1_KO_SEL        (0x3<<0)	

#define RG_SSUSB_G2_2EIOS_DET_EN           (0x1<<29)	
#define RG_SSUSB_P_SIGDET_CAL_OFFSET       (0x1f<<24)	
#define RG_SSUSB_P_FORCE_SIGDET_CAL_OFFSET (0x1<<16)	
#define RG_SSUSB_P_SIGDET_CAL_EN           (0x1<<8)	
#define RG_SSUSB_P_FORCE_SIGDET_CAL_EN     (0x1<<3)	
#define RG_SSUSB_P_SIGDET_FLT_EN           (0x1<<2)	
#define RG_SSUSB_P_SIGDET_SAMPLE_PRD       (0x1<<1)	
#define RG_SSUSB_P_SIGDET_REK              (0x1<<0)	

#define RG_SSUSB_RXDET_PRB_SEL             (0x1<<31)	
#define RG_SSUSB_FORCE_CMDET               (0x1<<30)	
#define RG_SSUSB_RXDET_EN                  (0x1<<29)	
#define RG_SSUSB_FORCE_RXDET_EN            (0x1<<28)	
#define RG_SSUSB_RXDET_K_TWICE             (0x1<<27)	
#define RG_SSUSB_RXDET_STB3_SET            (0x1ff<<18)	
#define RG_SSUSB_RXDET_STB2_SET            (0x1ff<<9)	
#define RG_SSUSB_RXDET_STB1_SET            (0x1ff<<0)	
...
#define RG_SSUSB_TX_EIDLE_LP_P0DLYCYC      (0x3f<<26)	
#define RG_SSUSB_TX_SER_EN                 (0x1<<25)	
#define RG_SSUSB_FORCE_TX_SER_EN           (0x1<<24)	
#define RG_SSUSB_TXPLL_REFCKSEL            (0x1<<23)	
#define RG_SSUSB_FORCE_PLL_DDS_HF_EN       (0x1<<22)	
#define RG_SSUSB_PLL_DDS_HF_EN_MAN         (0x1<<21)	
#define RG_SSUSB_RXLFPS_ENTXDRV            (0x1<<20)	
#define RG_SSUSB_RX_FL_UNLOCKTH            (0xf<<16)	
#define RG_SSUSB_LFPS_PSEL                 (0x1<<15)	
#define RG_SSUSB_RX_SIGDET_EN              (0x1<<14)	
#define RG_SSUSB_RX_SIGDET_EN_SEL          (0x1<<13)	
#define RG_SSUSB_RX_PI_CAL_EN              (0x1<<12)	
#define RG_SSUSB_RX_PI_CAL_EN_SEL          (0x1<<11)	
#define RG_SSUSB_P3_CLS_CK_SEL             (0x1<<10)	
#define RG_SSUSB_T2RLB_PSEL                (0x3<<8)	
#define RG_SSUSB_PPCTL_PSEL                (0x7<<5)	
#define RG_SSUSB_PHYD_TX_DATA_INV          (0x1<<4)	
#define RG_SSUSB_BERTLB_PSEL               (0x3<<2)	
#define RG_SSUSB_RETRACK_DIS               (0x1<<1)	
#define RG_SSUSB_PPERRCNT_CLR              (0x1<<0)	

#define RG_SSUSB_FRC_PLL_DDS_PREDIV2       (0x1<<31)	
#define RG_SSUSB_FRC_PLL_DDS_IADJ          (0xf<<27)	
#define RG_SSUSB_P_SIGDET_125FILTER        (0x1<<26)	
#define RG_SSUSB_P_SIGDET_RST_FILTER       (0x1<<25)	
#define RG_SSUSB_P_SIGDET_EID_USE_RAW      (0x1<<24)	
#define RG_SSUSB_P_SIGDET_LTD_USE_RAW      (0x1<<23)	
#define RG_SSUSB_EIDLE_BF_RXDET            (0x1<<22)	
#define RG_SSUSB_EIDLE_LP_STBCYC           (0x1ff<<13)	
#define RG_SSUSB_TX_EIDLE_LP_POSTDLY       (0x3f<<7)	
#define RG_SSUSB_TX_EIDLE_LP_PREDLY        (0x3f<<1)	
#define RG_SSUSB_TX_EIDLE_LP_EN_ADV        (0x1<<0)	

#define RGS_SSUSB_DDS_CALIB_C_STATE        (0x7<<16)	
#define RGS_SSUSB_PPERRCNT                 (0xffff<<0)	

#define RG_SSUSB_L1SS_REV1                 (0xff<<24)	
#define RG_SSUSB_L1SS_REV0                 (0xff<<16)	
#define RG_SSUSB_P_LTD1_SLOCK_DIS          (0x1<<11)	
#define RG_SSUSB_PLL_CNT_CLEAN_DIS         (0x1<<10)	
#define RG_SSUSB_P_PLL_REK_SEL             (0x1<<9)	
#define RG_SSUSB_TXDRV_MASKDLY             (0x1<<8)	
#define RG_SSUSB_RXSTS_VAL                 (0x1<<7)	
#define RG_PCIE_PHY_CLKREQ_N_EN            (0x1<<6)	
#define RG_PCIE_FORCE_PHY_CLKREQ_N_EN      (0x1<<5)	
#define RG_PCIE_PHY_CLKREQ_N_OUT           (0x1<<4)	
#define RG_PCIE_FORCE_PHY_CLKREQ_N_OUT     (0x1<<3)	
#define RG_SSUSB_RXPLL_STB_PX0             (0x1<<2)	
#define RG_PCIE_L1SS_EN                    (0x1<<1)	
#define RG_PCIE_FORCE_L1SS_EN              (0x1<<0)	

#define RG_SSUSB_RING_OSC_CNTEND           (0x1ff<<23)	
#define RG_SSUSB_XTAL_OSC_CNTEND           (0x7f<<16)	
#define RG_SSUSB_RING_OSC_EN               (0x1<<3)	
#define RG_SSUSB_RING_OSC_FORCE_EN         (0x1<<2)	
#define RG_SSUSB_FRC_RING_BYPASS_DET       (0x1<<1)	
#define RG_SSUSB_RING_BYPASS_DET           (0x1<<0)	

#define RG_SSUSB_RING_OSC_FRC_P3           (0x1<<20)	
#define RG_SSUSB_RING_OSC_P3               (0x1<<19)	
#define RG_SSUSB_RING_OSC_FRC_RECAL        (0x3<<17)	
#define RG_SSUSB_RING_OSC_RECAL            (0x1<<16)	
#define RG_SSUSB_RING_OSC_SEL              (0xff<<8)	
#define RG_SSUSB_RING_OSC_FRC_SEL          (0x1<<0)	

#define RG_SSUSB_RING_DET_STRCYC2          (0xffff<<16)	
#define RG_SSUSB_RING_DET_STRCYC1          (0xffff<<0)	

#define RG_SSUSB_RING_DET_DETWIN1          (0xffff<<16)	
#define RG_SSUSB_RING_DET_STRCYC3          (0xffff<<0)	

#define RG_SSUSB_RING_DET_DETWIN3          (0xffff<<16)	
#define RG_SSUSB_RING_DET_DETWIN2          (0xffff<<0)	

#define RG_SSUSB_RING_DET_LBOND1           (0xffff<<16)	
#define RG_SSUSB_RING_DET_UBOND1           (0xffff<<0)	

#define RG_SSUSB_RING_DET_LBOND2           (0xffff<<16)	
#define RG_SSUSB_RING_DET_UBOND2           (0xffff<<0)	

#define RG_SSUSB_RING_DET_LBOND3           (0xffff<<16)	
#define RG_SSUSB_RING_DET_UBOND3           (0xffff<<0)	

#define RG_SSUSB_RING_RESERVE              (0xffff<<16)	
#define RG_SSUSB_ROSC_PROB_SEL             (0xf<<2)	
#define RG_SSUSB_RING_FREQMETER_EN         (0x1<<1)	
#define RG_SSUSB_RING_DET_BPS_UBOND        (0x1<<0)	

#define RGS_FM_RING_CNT                    (0xffff<<16)	
#define RGS_SSUSB_RING_OSC_STATE           (0x3<<10)	
#define RGS_SSUSB_RING_OSC_STABLE          (0x1<<9)	
#define RGS_SSUSB_RING_OSC_CAL_FAIL        (0x1<<8)	
#define RGS_SSUSB_RING_OSC_CAL             (0xff<<0)	

#define RGS_SSUSB_ROSC_PROB_OUT            (0xff<<0)	

#define RGS_SSUSB_PHYD_VERSION             (0xffffffff<<0)	

#define RGS_SSUSB_PHYD_MODEL               (0xffffffff<<0)	
...
#define RG_SSUSB_SPLL_DDSEN_CYC                   (0x1f<<27)	
#define RG_SSUSB_SPLL_NCPOEN_CYC                  (0x3<<25)	
#define RG_SSUSB_SPLL_STBCYC                      (0x1ff<<16)	
#define RG_SSUSB_SPLL_NCPOCHG_CYC                 (0xf<<12)	
#define RG_SSUSB_SYSPLL_ON                        (0x1<<11)	
#define RG_SSUSB_FORCE_SYSPLLON                   (0x1<<10)	
#define RG_SSUSB_SPLL_DDSRSTB_CYC                 (0x7<<0)	

#define RG_SSUSB_PLL_BIAS_CYC                     (0xff<<24)	
#define RG_SSUSB_SYSPLL_STB                       (0x1<<23)	
#define RG_SSUSB_FORCE_SYSPLL_STB                 (0x1<<22)	
#define RG_SSUSB_SPLL_DDS_ISO_EN                  (0x1<<21)	
#define RG_SSUSB_FORCE_SPLL_DDS_ISO_EN            (0x1<<20)	
#define RG_SSUSB_SPLL_DDS_PWR_ON                  (0x1<<19)	
#define RG_SSUSB_FORCE_SPLL_DDS_PWR_ON            (0x1<<18)	
#define RG_SSUSB_PLL_BIAS_PWD                     (0x1<<17)	
#define RG_SSUSB_FORCE_PLL_BIAS_PWD               (0x1<<16)	
#define RG_SSUSB_FORCE_SPLL_NCPO_EN               (0x1<<15)	
#define RG_SSUSB_FORCE_SPLL_FIFO_START_MAN        (0x1<<14)	
#define RG_SSUSB_FORCE_SPLL_NCPO_CHG              (0x1<<12)	
#define RG_SSUSB_FORCE_SPLL_DDS_RSTB              (0x1<<11)	
#define RG_SSUSB_FORCE_SPLL_DDS_PWDB              (0x1<<10)	
#define RG_SSUSB_FORCE_SPLL_DDSEN                 (0x1<<9)	
#define RG_SSUSB_FORCE_SPLL_PWD                   (0x1<<8)	
#define RG_SSUSB_SPLL_NCPO_EN                     (0x1<<7)	
#define RG_SSUSB_SPLL_FIFO_START_MAN              (0x1<<6)	
#define RG_SSUSB_SPLL_NCPO_CHG                    (0x1<<4)	
#define RG_SSUSB_SPLL_DDS_RSTB                    (0x1<<3)	
#define RG_SSUSB_SPLL_DDS_PWDB                    (0x1<<2)	
#define RG_SSUSB_SPLL_DDSEN                       (0x1<<1)	
#define RG_SSUSB_SPLL_PWD                         (0x1<<0)	

#define RG_SSUSB_SPLL_P_ON_SEL                    (0x1<<11)	
#define RG_SSUSB_SPLL_FBDIV_CHG                   (0x1<<10)	
#define RG_SSUSB_SPLL_DDS_ISOEN_CYC               (0x3ff<<0)	

#define RG_SSUSB_SPLL_SDM_ISO_EN_CYC              (0x3ff<<14)	
#define RG_SSUSB_SPLL_FORCE_SDM_ISO_EN            (0x1<<13)	
#define RG_SSUSB_SPLL_SDM_ISO_EN                  (0x1<<12)	
#define RG_SSUSB_SPLL_SDM_PWR_ON_CYC              (0x3ff<<2)	
#define RG_SSUSB_SPLL_FORCE_SDM_PWR_ON            (0x1<<1)	
#define RG_SSUSB_SPLL_SDM_PWR_ON                  (0x1<<0)	

#define RG_SSUSB_BIAS_STBCYC                      (0x3fff<<17)	
#define RG_SSUSB_XTAL_CLK_REQ_N                   (0x1<<16)	
#define RG_SSUSB_XTAL_FORCE_CLK_REQ_N             (0x1<<15)	
#define RG_SSUSB_XTAL_STBCYC                      (0x7fff<<0)	

#define RG_SSUSB_INT_XTAL_SEL                     (0x1<<29)	
#define RG_SSUSB_BG_LPF_DLY                       (0x3<<27)	
#define RG_SSUSB_BG_LPF_EN                        (0x1<<26)	
#define RG_SSUSB_FORCE_BG_LPF_EN                  (0x1<<25)	
#define RG_SSUSB_P3_BIAS_PWD                      (0x1<<24)	
#define RG_SSUSB_PCIE_CLKDET_HIT                  (0x1<<20)	
#define RG_SSUSB_PCIE_CLKDET_EN                   (0x1<<19)	
#define RG_SSUSB_FRC_PCIE_CLKDET_EN               (0x1<<18)	
#define RG_SSUSB_USB20_BIAS_EN                    (0x1<<17)	
#define RG_SSUSB_USB20_SLEEP                      (0x1<<16)	
#define RG_SSUSB_OSC_ONLY                         (0x1<<9)	
#define RG_SSUSB_OSC_EN                           (0x1<<8)	
#define RG_SSUSB_XTALBIAS_STB                     (0x1<<5)	
#define RG_SSUSB_FORCE_XTALBIAS_STB               (0x1<<4)	
#define RG_SSUSB_BIAS_PWD                         (0x1<<3)	
#define RG_SSUSB_XTAL_PWD                         (0x1<<2)	
#define RG_SSUSB_FORCE_BIAS_PWD                   (0x1<<1)	
#define RG_SSUSB_FORCE_XTAL_PWD                   (0x1<<0)	
