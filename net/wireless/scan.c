...
#define IEEE80211_SCAN_RESULT_EXPIRE_BAND	(1 * HZ)
...
void  cfg80211_bss_expire_band(struct cfg80211_registered_device *rdev)
{
	 __cfg80211_bss_expire(rdev, jiffies - IEEE80211_SCAN_RESULT_EXPIRE_BAND);
}
